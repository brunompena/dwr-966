...
ifeq ($(LINUX_VERSION),3.6.11)
  LINUX_KERNEL_MD5SUM:=3ff269b161f6cc319aa220b16963e213
endif
ifeq ($(LINUX_VERSION),3.7.10)
  LINUX_KERNEL_MD5SUM:=56ec294a922b6112a1ef129668f38a83
endif
ifeq ($(LINUX_VERSION),3.8.13)
  LINUX_KERNEL_MD5SUM:=db03acc21c41fc6bea8ddf7a77fc83aa
endif
ifeq ($(LINUX_VERSION),3.10.12)
  LINUX_KERNEL_MD5SUM:=c1b08676b7d16b526c51473306d9fa45
endif

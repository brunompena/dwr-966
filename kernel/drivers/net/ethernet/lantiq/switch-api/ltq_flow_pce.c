...
const PCE_MICROCODE pce_mc_max_ifx_tag_m = {
    ...
    **                value    mask   ns  out_fields   L  type     flags       ipv4_len
	...
	PCE_MC_M(0x0000 , 0x0000 , 38 , OUT_ETHTYP ,	1 , INSTR , FLAG_NO , 0),
	PCE_MC_M(0x0600 , 0x0600 , 38 , OUT_ETHTYP ,	1 , INSTR , FLAG_NO , 0),
	PCE_MC_M(0x0000 , 0x0000 , 12 , OUT_NONE , 1 , INSTR , FLAG_NO , 0),
	PCE_MC_M(0xAAAA , 0xFFFF , 14 , OUT_NONE , 1 , INSTR , FLAG_NO , 0),
	PCE_MC_M(0x0000 , 0x0000 , 39 , OUT_NONE ,		0 , INSTR , FLAG_NO , 0),
	PCE_MC_M(0x0300 , 0xFF00 , 39 , OUT_NONE ,		0 , INSTR , FLAG_SNAP , 0),
	PCE_MC_M(0x0000 , 0x0000 , 39 , OUT_NONE ,		0 , INSTR , FLAG_NO , 0),
	PCE_MC_M(0x0000 , 0x0000 , 39 , OUT_DIP7 ,		3 , INSTR , FLAG_NO , 0),
	...
	PCE_MC_M(0x0000 , 0x0000 , 38 , OUT_NONE ,		0 , LENACCU , FLAG_NO , 0),
	PCE_MC_M(0x1100 , 0xFF00 , 37 , OUT_PROT ,		1 , INSTR , FLAG_NO , 0),
	PCE_MC_M(0x0600 , 0xFF00 , 37 , OUT_PROT ,		1 , INSTR , FLAG_NO , 0),
	...
	PCE_MC_M(0x0000 , 0x0000 , 37 , OUT_PROT ,		1 , INSTR , FLAG_NO , 0),
	...
	PCE_MC_M(0x0000 , 0x0000 , 38 , OUT_PROT ,		1 , IPV6 ,  FLAG_NO , 0),
	PCE_MC_M(0x0000 , 0x0000 , 38 , OUT_SIP0 ,		16, INSTR , FLAG_NO , 0),
	PCE_MC_M(0x0000 , 0x0000 , 39 , OUT_APP0 ,		4 , INSTR , FLAG_IGMP , 0),
	PCE_MC_M(0x0000 , 0x0000 , 39 , OUT_NONE ,		0 , INSTR , FLAG_END , 0),
	PCE_MC_M(0x0000 , 0x0000 , 39 , OUT_NONE ,		0 , INSTR , FLAG_END , 0),
	PCE_MC_M(0x0000 , 0x0000 , 39 , OUT_NONE ,		0 , INSTR , FLAG_END , 0),
	PCE_MC_M(0x0000 , 0x0000 , 39 , OUT_NONE ,		0 , INSTR , FLAG_END , 0),
	PCE_MC_M(0x0000 , 0x0000 , 39 , OUT_NONE ,		0 , INSTR , FLAG_END , 0),

...
static const struct ltq_mfp_pin xway_mfp[] = {
	...
	MFP_XWAY(GPIO26, GPIO,	EBU,	TDM,	NONE),
...
static const unsigned pins_tdm[] = {GPIO26, GPIO27, GPIO58};
static const unsigned pins_tdm_do[] = {GPIO25};
static const unsigned pins_tdm_gpio[] = {GPIO25};
...
/* xrx only */
	...
	GRP_MUX("tdm_do", TDM, pins_tdm_do),
	GRP_MUX("tdm_gpio", GPIO, pins_tdm_gpio),
};
...
static const char * const xway_tdm_grps[] = {"tdm"};
static const char * const xway_tdm_do_grps[] = {"tdm_do"};
static const char * const xway_tdm_gpio_grps[] = {"tdm_gpio"};
...
static const struct ltq_pmx_func xrx_funcs[] = {
	...
	{"tdm",		ARRAY_AND_SIZE(xway_tdm_grps)},
	{"tdm_do",	ARRAY_AND_SIZE(xway_tdm_do_grps)},
	{"tdm_gpio",	ARRAY_AND_SIZE(xway_tdm_gpio_grps)},
};

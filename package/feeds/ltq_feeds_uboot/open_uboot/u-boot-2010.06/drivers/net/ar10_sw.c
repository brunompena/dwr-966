...
void config_phy_led()
{
    ...
    *AR10_GPIO_P1_ALTSEL1 |= 1<<3;
	...
	//GPIO_3, SR_EN, output low to enable shift LED
	*AR10_GPIO_P0_DIR |= (0x1 << 3);
	*AR10_GPIO_P0_ALTSEL0 &= ~(0x1 << 3);
	*AR10_GPIO_P0_ALTSEL1 &= ~(0x1 << 3) ;
	*AR10_GPIO_P0_OD |= (0x1 << 3);
	*AR10_GPIO_P0_OUT &= ~(0x1 << 3);

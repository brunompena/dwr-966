  ...
  "part1_err=0\0"
  "part2_err=0\0"
  "dark_led=mw.l  0xbe100bb8 0xFFE483\0"
  "green_led=mw.l  0xbe100bb8 0x090402\0"
  "red_led=mw.l  0xbe100bb8 0xF6E081\0"
  "all_led=mw.l  0xbe100bb8 0x001010\0"
  "f_kernel_crc=0\0"
  "f_kernel_datalen=0\0"
  "f_rootfs_crc=0\0"
  "f_rootfs_datalen=0\0"
  "part1_version=0\0"
  "f_kernelb_crc=0\0"
  "f_kernelb_datalen=0\0"
  "f_rootfsb_crc=0\0"
  "f_rootfsb_datalen=0\0"
  "part2_version=0\0"  
  "data_2m=0x200000\0"
  "data_16m=0x1000000\0"
  "rootfsname=rootfs\0"
  "kernelname=kernel\0"
  "switch2parta=setenv kernelname kernel;setenv rootfsname rootfs;saveenv;reset\0"
  "switch2partb=setenv kernelname kernelb;setenv rootfsname rootfsb;saveenv;reset\0"
  ...
  "update_kernelb=ubi part system_sw;ubi remove kernelb;ubi create kernelb 0x200000 dynamic 3;tftpboot $(loadaddr) $(tftppath)$(bootfile);ubi write $(loadaddr) kernelb $(filesize)\0"
  "update_bootloader="CONFIG_UPDATE_BOOTLOADER"\0"
  "update_rootfs="CONFIG_UPDATE_ROOTFS"\0"          
  "update_rootfsb=ubi part system_sw;ubi remove rootfsb;ubi create rootfsb 0x1000000 dynamic 4;tftpboot $(loadaddr) $(tftppath)$(rootfs);ubi write 0x80800040 rootfsb $(filesize)\0"
#ifdef CONFIG_UPDATE_FIRMWARE
  "update_firmware="CONFIG_UPDATE_FIRMWARE"\0"      
#endif 
  "update_fullimage="CONFIG_UPDATE_FULLIMAGE"\0"    
  "update_fullimageb=setenv kernel_vol kernelb;setenv rootfs_vol rootfsb;setenv kernelb_id 3;setenv rootfsb_id 4;ubi part system_sw;tftpboot $(loadaddr) $(tftppath)$(fullimage);upgrade $(loadaddr) $(filesize) 2;setenv rootfsname rootfsb;setenv kernelname kernelb;setenv part2_err 0;saveenv\0"

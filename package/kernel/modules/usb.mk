...
define AddDepends/usb-serial-wwan
  SUBMENU:=$(USB_MENU)
  DEPENDS+=kmod-usb-serial-wwan $(1)
endef
...
define KernelPackage/usb-serial-qualcomm
  ...
  $(call AddDepends/usb-serial)
  $(call AddDepends/usb-serial-wwan)
endef
...
define KernelPackage/usb-net-msm-rmnet-usb
  TITLE:=RMNET USB Driver
  KCONFIG:= \
	CONFIG_MSM_RMNET_USB \
	CONFIG_RMNET_DATA=y \
	CONFIG_RMNET_DATA_FC=y
  FILES:=$(LINUX_DIR)/drivers/net/usb/rmnet_usb.ko
  AUTOLOAD:=$(call AutoLoad,64,rmnet_usb)
  $(call AddDepends/usb-net)
endef

define KernelPackage/usb-net-msm-rmnet-usb/description
 Kernel support for RMNET USB Drive
endef

$(eval $(call KernelPackage,usb-net-msm-rmnet-usb))

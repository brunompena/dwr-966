 ...
 *
 * $Id: security.c,v 1.3 2007-02-01 07:41:01 winfred Exp $
 */
 ...
 */
        ...
        if (!umUserExists(userid)) {
            ...
            websStats.access++;
            #ifdef WEBS_LOGOUT_SUPPORT
            websError(wp, 401, T("Access to this document requires a Admin ID"));
            #else

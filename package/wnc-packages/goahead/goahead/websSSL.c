...
#define DEFAULT_CERT_FILE	"/usr/local/etc/server.pem"
#define DEFAULT_KEY_FILE	"/usr/local/etc/certs/cakey.pem"
#define DEFAULT_CA_FILE		"/usr/local/etc/certs/cacert.pem"
#define DEFAULT_CA_PATH		"/usr/local/etc/certs/"
#define SSL_PORT			443
...
static int websSSLReadEvent (webs_t wp)
{
	...
	a_assert(sptr);
	// GARYeh 20131120: add patch for SSL web hang issue
	struct timeval tv;

...
cp /var/log/messages /var/log/messages1
echo "" > /var/log/messages
if [ -e /tmp/malmanager.log ] ; then
  tar -zcf $BACKUP_LOG_PATH/$LOG_NAME /var/log/messages1 /var/log/messages_webui_all.log /tmp/mald.log /tmp/libmal.log /tmp/malmanager.log /tmp/tr69client.log /tmp/tr69log.gz
else
  tar -zcf $BACKUP_LOG_PATH/$LOG_NAME /var/log/messages1 /var/log/messages_webui_all.log /tmp/lte.log /tmp/ltelog.gz /tmp/tr69client.log /tmp/tr69log.gz
fi

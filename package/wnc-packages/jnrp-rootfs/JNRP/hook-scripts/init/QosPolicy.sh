...
CONFIG_FILE=/mnt/data/QoS/QoS_Policy
...
# Configure DownLink Traffic Rules to /mnt/data/QoS/QoS_Policy
...
# Configure 3G/4G UpLink Traffic Rules to /mnt/data/QoS/QoS_Policy

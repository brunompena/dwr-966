...
CREATE TABLE wifiEnableStatus
(
    profileName  text NOT NULL,
    WIFIStatus_1 integer NOT NULL,  --previous wifi enable value of SSID1
    WIFIStatus_2 integer NOT NULL,  --previous wifi enable value of SSID2
    PRIMARY KEY (profileName)
)
;

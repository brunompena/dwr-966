...
--------------------
01b,15jul08,rnp  added 'Invalid Process Id' string to ADPCMD_ERROR_STRINGS
01a,08apr08,san  written (based on linux\adpCmdLib.c)
*/

/*
DESCRIPTION
This file implements api to work with command execution for integrity
*/

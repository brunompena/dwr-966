/* adpMemLib.c - adaptos memory allocation library for Integrity */
...
--------------------
01b,28jun08,rnp  changed ADP_SYS_MEM_PART to adpSysMemPart
01a,08apr08,san  created (based on linux\adpMemLib.c).
*/
...
*
* Integrity doesnt have memory partitions. So we always uses system-wide memory
* partition
*

/* adpTaskLib.c - adaptos task library for Integrity */
...
This library provides all the task-related support for Integrity
...
LOCAL void * adpIntTaskEntryPoint (void * params);
...
* spawned task.
*
* RETURNS: The task Id, or ST_ERROR otherwise
*/
...
int adpTaskSpawn
    ...
    retCode = pthread_create (&taskId, NULL, adpIntTaskEntryPoint,
                              (void *) pTaskParam);
...
/*******************************************************************************
*
* adpIntTaskEntryPoint - adaptos task entry point
*
* This routine is the adaptos task entry point for Integrity. It unpacks
...
LOCAL void * adpIntTaskEntryPoint
    (
...
*
* RETURNS: The task Id, or ST_ERROR on failure
*/

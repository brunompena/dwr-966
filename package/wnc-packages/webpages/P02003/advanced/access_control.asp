...
<div class="contentBg">
	...
	<div class="secH2"><script>document.write(gettext("Access Control"));</script></div>

	<div class="secInfo">
		<br><script>document.write(gettext("A list of all configured filtering rules is displayed here. Filtering rules for computers indicate whether a defined application is specifically allowed or blocked for use for that computer."));</script>
		<br>
	</div>
	<form method="post" action="/goform/setACLTable?<%getUniName();%>=<%getUniId();%>">
		...
		<div class="submitBg">
		 <table border="0" cellpadding="0" cellspacing="0">
		  <tr>
		   <td><input type="submit" class="tblbtn" id="acl_add" value="Add" title="Add" name="ACLTblAdd" onmouseover="this.className = 'tblbtnHover'" onmouseout="this.className = 'tblbtn'" onclick="return acl_list_action('add');"></td>
		   <td><input type="submit" class="tblbtn" id="acl_edit" value="Edit" title="Edit" name="ACLTblEdit" onmouseover="this.className = 'tblbtnHover'" onmouseout="this.className = 'tblbtn'" onclick="return acl_list_action('edit');"></td>
		   <td><input type="submit" class="tblbtn" id="acl_delete" value="Delete" title="Delete" name="ACLTblDel" onmouseover="this.className = 'tblbtnHover'" onmouseout="this.className = 'tblbtn'" onclick="return acl_list_action('delete');"></td>
		  </tr>
		 </table>
		</div>
	</form>
...
<script type="text/javascript">
  document.getElementById('acl_add').value=gettext("Add");
  document.getElementById('acl_edit').value=gettext("Edit");
  document.getElementById('acl_delete').value=gettext("Delete");
</script>
</body>
</html>

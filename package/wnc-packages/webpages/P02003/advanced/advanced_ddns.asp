...
<div class="contentBg">
  ...
  <br />
		...
		<form name="advanced_ddns_1" method="post" action="/goform/setDNSInfo?<%getUniName();%>=<%getUniId();%>">
  <table cellspacing="0" class="configTbl">
    <tr>
     <td><script>document.write(gettext("Host"));</script></td>
     <td>
  ...
  <form name="advanced_ddns_2" method="post" action="/goform/setDDNSInfo?<%getUniName();%>=<%getUniId();%>">
  <table cellspacing="0" class="configTbl">
    <tr>
     ...
     <td>
       <select name="selDDNSService" size="1" class="configF1" id="selDDNSService" onchange="selectDDNSService();">
         <option value="none"><script>document.write(gettext("None"));</script></option>

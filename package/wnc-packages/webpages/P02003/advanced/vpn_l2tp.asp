...
<div class="contentBg">
	...
	<form name="VPN_L2TP" action="/goform/setVpnServerL2TP?<%getUniName();%>=<%getUniId();%>" method="post">  
	...
	<div class="secInfo">		
	    ...
	    <form name="VPN_CLIENT_L2TP" action="/goform/setVpnClientL2TP?<%getUniName();%>=<%getUniId();%>" method="post"> 

...
<div class="contentBg">
	...
	<form name="VPN_PPTP" action="/goform/setVpnServerPPTP?<%getUniName();%>=<%getUniId();%>" method="post">  
	...
	<form method="post" action="/goform/setVpnUserTbl?<%getUniName();%>=<%getUniId();%>">	
	...
	<div class="secInfo">		
      ...
      <form name="VPN_CLIENT_PPTP" action="/goform/setVpnClientPPTP?<%getUniName();%>=<%getUniId();%>" method="post">

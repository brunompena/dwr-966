...
<div class="contentBg">
	...
	<div class="secBg">
		...
		<form name="internet_change_pin" method="post" action="/goform/setChangePin?<%getUniName();%>=<%getUniId();%>">

...
function loadPingTestPage()
{
	...
	progress.innerHTML = "Enter a host name or IP address above and click 'Ping'";
...
function process_start(ipv6_type)
{
	...
	if (host_name == "") {
		alert("Please enter either a Host Name or an IP Address");
		return false;
	}
	process_clean();

...
function numericValueRangeCheck
	...
	{
	var i18n_enterValBtw = gettext("Please enter a value between ");
...
{
	var fieldErrMsg1 = gettext("Only allow to input ASCII characters.");
	var fieldErrMsg2 = gettext("Empty Space, Single Quote and Double Quote characters are not supported for this field.");

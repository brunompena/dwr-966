...
<%writeMainMenu();%>
<%writeLeftMenu("lan");%>
<script type="text/javascript">menuChange("lan_menu");leftMenuChange("lan_clientlist", "lan_clientlist_href");</script>
...
<div class="contentBg">
   ...
   <%getLanClients();%>
		...
		<div>
			<form action="/goform/updateClientList?<%getUniName();%>=<%getUniId();%>" method="post">
   <input type="hidden" name="clientlist" value="0" />
   <input type="hidden" name="url_clientlist" value="lan" />

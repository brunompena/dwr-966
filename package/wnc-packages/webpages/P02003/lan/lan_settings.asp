...
function pageValidate()
{
 ...
 {
  if (confirm(gettext("LAN IP Address conflicts with DHCP range, are you sure?"))) {
  } else {
    return false;
  }
 }
...
<div class="contentBg">
	...
	<div class="secBg">
		...
		<form name="LAN_BASIC" action="/goform/setLanInfoValue?<%getUniName();%>=<%getUniId();%>" method="post">

<div class="mainMenuBg1" id="mainMenu1"></div>
<div class="mainMenuBg2" id="mainMenu2">
 <table width="1000" border="0" cellspacing="0" cellpadding="0">
  <tr>
   <td width="230" height="121"><a href="http://www.cyfrowypolsat.pl" target="_blank"><img src="../images/menu/Top_Logo_CP.jpg" width="230" height="121" /></a></td>
     ...
     <tr>
      ...
      <td width="60" id="lte_menu" class="topMenuTd_Internet">
       <a href="#" onclick="RedirectMainMenu('internet/internet_status');" id="lte_menu_href" class="topMenuTd_Internet_Href">
        ...
        <script>document.write(gettext("LTE/3G"));</script>
       </a>
      </td>
      <td width="27" class="mainMenuBg2_bg"></td>
      ...
      <td width="60" id="adv_menu" class="topMenuTd_Advanced">
       ...
       <a href="#" onclick="RedirectMainMenu('advanced/advanced_ddns');" id="adv_menu_href" class="topMenuTd_Advanced_Href">
...
if (select_language == "en")
	help_link = "../help/help_" + file_name;
else
	help_link = "../help/PL/help_" + file_name;

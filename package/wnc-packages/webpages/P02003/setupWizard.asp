 ...
 <head>
  ...
  <script language="JavaScript" type="text/javascript">
   ...
   function pinStatusEnable()
   {
	    ...
	    if(pinStatus == "2" || pinStatus == "4" || pinStatus == "1"){
	      ...
	      return;
	       ...
	       alert("Enheten er opptatt. Vennligst prøv igjen senere.");
	       return;
	    }
	    ...
	    if (pinStatus == "1") {  //PIN enabled, not verified
			...
			document.action_setup_pin_code.action = "/goform/setSetupWizardVerifyPIN?<%getUniName();%>=<%getUniId();%>";
			...
			document.action_setup_pin_code.action = "/goform/setSetupWizardUnblockPUK?<%getUniName();%>=<%getUniId();%>";
   ...
   function onShowPinCode()
   {
	    ...
	    document.getElementById('setup_wait').className="hide";
   ...
   function onNextComfirm()
   {
     ...
     document.getElementById("confirm_ssid_ac").innerHTML = strSSID + "_5GHz";
     document.getElementById("confirm_psk_ac").innerHTML = strPSK;
   }
   ...
   function onShowReady()
   {
	    ...
	    setTimeout(onVisitWebsite, 1000);
   }
   ...
   function wifiValidate()
   {
     ...
     if (wifi_ssid.length < 1 || wifi_ssid.length > 27)
     {
      	//SSID: Please enter 1-27 characters.
      	alert("SSID: Må være mellom 1-27 tegn");
      	return false;
     }
     ...
     //{
       ...
       if(!pwd_rule1.test(wifi_psk)){
         alert("Nettverkspassord: Kan bare benytte tegnene [a-z], [A-Z], [0-9]");
         return false;
       }
   ...
   {
	    window.open("http://www.telenor.no/privat/mobiltbredband/velkommen.jsp");
	    return;
   }
   ...
   function getAllValues()
   {
     ...
     document.getElementById("confirm_pincode").value = CurPinCodeArr[0];
     document.getElementById("confirm_pincode").disabled = true;
   }

   function checkCommonNameField(fieldId, fieldTitle, fieldErrMsg)
   {
     //var errStr2 = "The first character cannot be '_', '-', '.' and '@'"
     var errStr2 = "Det første tegnet kan ikke være '_', '-', '.' og '@'";
   ...
   function displayRebootMsg()
   {
     ...
     chart.innerHTML = "Gjenstående tid" + "&nbsp;&nbsp;" + count + "&nbsp;&nbsp;" + "sekunder";
     count = count-1;
     if (count <= -1)
     {
       clearInterval(counter);
       //chart.innerHTML = "Ready";
       onShowReady();
       return;
     }
   }
   ...
   function onShowWait()
   {
     counter = setInterval(displayRebootMsg, 1000);
	    ...
	    document.getElementById('setup_admin').className="hide";
	    document.getElementById('setup_confirm').className="hide";
	    document.getElementById('setup_wait').className="show";
	    document.getElementById('setup_ready').className="hide";
 ...
 <body onload="getAllValues();enablePinConfig();">
  ...
  <div class="content">
    ...
    <div class="settings">
      <table>
        <tr>
          ...
          <td>
          	<input type="text" name="ssid" id="ssid" value="" size="25" maxlength="27" onkeyup="enablePSKKey('pskPassAscii');" />
        ...
        <tr>
          ...
          <td>
          	<input type="text" name="pskPassAscii" id="pskPassAscii" value="" size="25" maxlength="63" onkeyup="checkPassAscii('pskPassAscii');" />
   ...
   <div id="setup_confirm" class="hide">
    <div class="title">
      ...
      <form name="action_setup_confirm" method="post" action="/goform/setSetupWizardFinish?<%getUniName();%>=<%getUniId();%>">
      <table class="mobileinfo">
       <tr>
        <!--SSID:-->
        <th>[Wi-Fi 2.4GHz] Ditt nettverksnavn:</th>
        <td id="confirm_ssid"></td>
       </tr>
       <tr>
        <!--Wi-Fi Password:-->
        <th>[Wi-Fi 2.4GHz] Ditt nettverkspassord:</th>
        <td id="confirm_psk"></td>
       </tr>
       <tr>
        <!--SSID:-->
        <th>[Wi-Fi 5GHz] Ditt nettverksnavn:</th>
        <td id="confirm_ssid_ac"></td>
       </tr>
       <tr>
        <!--Wi-Fi Password:-->
        <th>[Wi-Fi 5GHz] Ditt nettverkspassord:</th>
       ...
       <tr>
        ...
        <td><input type="password" id="confirm_pincode" namd="confirm_pincode" value=""/></td>
       </tr>
       <tr>
        <!--Admin Password:-->
        <th>Admin passord:</th>
   ...
   <div id="setup_wait" class="hide">
    <div class="title">
      <h2>Konfigurerer opp Mobilt Bredbåndsruter</h2>
    </div>
    <div class="settings">
     <table>
       <tr>
         <td>Vent litt:&nbsp;&nbsp;</td>
         <td id="countdown">Gjenstående tid&nbsp;&nbsp;20&nbsp;&nbsp;sekunder</td>
       </tr>
     </table>
    </div>
   </div>
  ...
  <div id="setup_change_pin_popup" class="hide">
   <div class="popup_frame">
    ...
    <div class="settings">
      <form name="action_setup_change_pin_popup" method="post" action="/goform/setSetupWizardChangePin?<%getUniName();%>=<%getUniId();%>">
      <table>
        <tr>
          <!--Old PIN-->

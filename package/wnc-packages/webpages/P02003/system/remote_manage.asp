...
function remoteMgmtValidation()
{
	if(!CheckLoginInfo())
		return false;
	var i18n_enterValidFromIP = gettext("Please enter a valid From IP address.");
	var i18n_enterValidToIP = gettext("Please enter a valid To IP address");
	var i18n_enterValidIP = gettext("Please enter a valid IP Address");
	var i18n_enterValidPort = gettext("Please enter a valid Port");
	var i18n_invalidIP = gettext("Invalid IP Address.");
	...
	if(ipv4Validate("txtRemoteFromAddr",gettext("IP"),false,true,i18n_invalidIP,i18n_forOctet,true)==false)
	{
		return false;
	}
	if(ipv4Validate("txtRemoteToAddr",gettext("IP"),false,true,i18n_invalidIP,i18n_forOctet,true)==false)
	{
		return false;
	}
	if(ipv4Validate("txtOnlyThisPC",gettext("IP"),false,true,i18n_invalidIP,i18n_forOctet,true)==false)
	{
		return false;
	}
...
<br></div>
		<form name="REMOTE_MANAGEMWNT" action="/goform/setRemManage?<%getUniName();%>=<%getUniId();%>" method="post">
		...
		<form name="DEL_IP_RANGE" action="/goform/setRemManageAction?<%getUniName();%>=<%getUniId();%>" method="post">

...
function pageValidate ()
{
	...
	txtFieldIdArr[0] = "txtStartIP," + gettext("Please enter a valid MAC Address in the form XX:XX:XX:XX:XX:XX");
	txtFieldIdArr[1] = "txtEndIP," + gettext("Please enter a valid IP Address");
	...
	if (ipv4Validate ('txtStartIP', gettext("IP"), false, true,gettext("Invalid IP Address."), gettext("for octet "), true) == false)
		return false;
    
	if (ipv4Validate ('txtEndIP', gettext("IP"), false, true,gettext("Invalid IP Address."), gettext("for octet "), true) == false)
		return false;
...
<div class="contentBg" id="rem_manage_add">
	...
	<form name="SET_IP_RANGE" action="/goform/setIpRange?<%getUniName();%>=<%getUniId();%>" method="post">

...
<body onload="pageLoad();secChkBoxSelectOrUnselectAll ('tblusers', 'umiId', null);">
...
<div class="contentBg" id="main_user">
	...
	<div class="secBg">
		...
		<form name="user_account_del" method="post" action="/goform/setUserAccountAction?<%getUniName();%>=<%getUniId();%>">
		...
		<div>
			<input type="submit" id="add_user" value="Add" class="tblbtn" title="Add" name="add_user" onmouseover="this.className = 'tblbtnHover'" onmouseout="this.className = 'tblbtn'" onclick="return NewUserAction('add');">
			<input type="submit" id="edit_user" value="Edit" class="tblbtn" title="Edit" name="edit_user" onmouseover="this.className = 'tblbtnHover'" onmouseout="this.className = 'tblbtn'" onclick="return NewUserAction('edit');">
			<input type="submit" id="delete_user" value="Delete" class="tblbtn" title="Delete" name="delete_user" onmouseover="this.className = 'tblbtnHover'" onmouseout="this.className = 'tblbtn'" onclick="return NewUserAction('delete');">
		</div>
		</form>
	</div>
	<!-- Section End -->

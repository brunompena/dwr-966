...
function checkWIFIAdvSettings()
{
	...
	document.wifi_setting.action="/goform/setWifiRadioAC?<%getUniName();%>=<%getUniId();%>";
    ...
    <table class="configTbl">
      <tr>
    	...
    	<td><select class="configF1" name="wifi_mode" id="wifi_mode" size="1" onChange="selectMode();">
          <option value="a"><script>document.write(gettext("a only"));</script>&nbsp;</option>
          <option value="an"><script>document.write(gettext("a/n mode"));</script>&nbsp;</option>
          <option value="ac"><script>document.write(gettext("ac mode"));</script>&nbsp;</option>
      	</select></td>
      </tr>
      ...
      <td><select class="configF1" name="wifi_width2" id="wifi_width2" size="1" onChange="selectWidth2();">
          <option value="20">20 MHz</option>
          <option value="2040">20/40 MHz</option>
        </select></td>      
      </tr>
      ...
      <td><select class="configF1" name="wifi_width3" id="wifi_width3" size="1" onChange="selectWidth3();">
          <option value="20">20 MHz</option>
          <option value="2040">20/40 MHz</option>
          <option value="80">20/40/80 MHz</option>
        </select></td>      
      </tr>
  	  <tr id="wifiband" style="display:none;">
      <td><script>document.write(gettext("Sideband"));</script></td>

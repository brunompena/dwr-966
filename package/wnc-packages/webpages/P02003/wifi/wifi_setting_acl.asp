...
<div class="contentBg">
  ...
  <form name="wifi_acl_setting" method="post" action="/goform/setWifiACLSetting?<%getUniName();%>=<%getUniId();%>">
  ...
  <form name="wifi_acl_list" method="post" action="/goform/setWifiACLList?<%getUniName();%>=<%getUniId();%>">

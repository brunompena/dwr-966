...
[ -n "$1" ] && {
	case "$1" in
		tr69)
			...
			stop_daemons; stop_web; stop_tftp; stop_wlan; stop_usb; stop_voip;
			stop_multicast; stop_qos; stop_misc; free_ramdisk;;
		http)
			echo "free_memory.sh: Free-up memory for http";
			stop_daemons; stop_tr69; stop_tftp; stop_usb; stop_voip; stop_multicast;
			stop_qos; stop_dsl; stop_misc; free_ramdisk;;
		tftp)
			echo "free_memory.sh: Free-up memory for tftp";
			stop_daemons; stop_web; stop_tr69; stop_stunnel; stop_wlan; stop_usb; stop_voip;
	...
	stop_daemons; stop_web; stop_tr69; stop_stunnel; stop_tftp; stop_wlan; stop_usb; stop_voip;

/******************************************************************************
**
** FILE NAME    : ppa_datapath_xrx200_e5.c
** PROJECT      : UEIP
...
#include "ppa_datapath_fw_xrx200_e1.h"
#include "ppa_hal_xrx200_e5.h"
 ...
 */
#include "xrx200_bonding_fw_data_structure.h"
#include "xrx200_bonding_addr_def.inc"
...
#ifdef CONFIG_LTQ_PPE_E5_OFFCHIP_BONDING
...
#if defined(CONFIG_DSL_MEI_CPE_DRV) && !defined(CONFIG_LTQMIPS_DSL_CPE_MEI)
...
#define DMA_PACKET_SIZE                         1600    //  ((1518 + 8 <2 VLAN> + 62 <PPE FW> + 8 <SW Header>) + 31) & ~31, both bonding and 6rd/ds-lite require 1600
#define DMA_ALIGNMENT                           32
#define DMA_ALIGNED(x)                          (((unsigned int)(x) + DMA_ALIGNMENT - 1) & ~(DMA_ALIGNMENT - 1))
...
#define US_BOND_PKT_DES_BASE(i)                 ((volatile struct US_BOND_PKT_DES *)SB_BUFFER(2, __US_BOND_PKT_DES_BASE(i)))
#define __US_BG_CTXT_BASE(i)                    (__US_BG_CTXT + (i) * 4)
#define US_BG_CTXT_BASE(i)                      ((volatile struct US_BG_CTXT *)SB_BUFFER(2, __US_BG_CTXT_BASE(i)))
#define __DS_BOND_GIF_LL_DES_BASE(i)            (__DS_BOND_GIF_LL_DESBA + (i) * 2)
#define DS_BOND_GIF_LL_DES_BASE(i)              ((volatile struct DS_BOND_GIF_LL_DES *)SB_BUFFER(2, __DS_BOND_GIF_LL_DES_BASE(i)))
#define DS_BOND_FREE_LL_CTXT_BASE               ((volatile struct DS_BOND_GIF_LL_CTXT *)SB_BUFFER(2, __DS_BOND_FREE_LL_CTXT))
#define __DS_BOND_GIF_LL_CTXT_BASE(i)           (__DS_BOND_GIF_LL_CTXT + (i) * 4)
#define DS_BOND_GIF_LL_CTXT_BASE(i)             ((volatile struct DS_BOND_GIF_LL_CTXT *)SB_BUFFER(2, __DS_BOND_GIF_LL_CTXT_BASE(i)))
#define __DS_BG_CTXT_BASE(i)                    (__DS_BG_CTXT + (i) * 8)
#define DS_BG_CTXT_BASE(i)                      ((volatile struct DS_BG_CTXT *)SB_BUFFER(2, __DS_BG_CTXT_BASE(i)))
#define __DS_BOND_GIF_MIB_BASE(i)               (__DS_BOND_GIF_MIB + i * 16)
#define DS_BOND_GIF_MIB_BASE(i)                 ((volatile struct DS_BOND_GIF_MIB *)SB_BUFFER(2, __DS_BOND_GIF_MIB_BASE(i)))
#define __DS_BG_MIB_BASE(i)                     (__DS_BG_MIB + i * 16)
#define DS_BG_MIB_BASE(i)                       ((volatile struct DS_BG_MIB *)SB_BUFFER(2, __DS_BG_MIB_BASE(i)))
#define US_BOND_GIF_MIB(i)                      SB_BUFFER(2, __US_E1_FRAG_Q_FRAG_MIB + (i))
 ...
 */
#define CPU_TO_WAN_TX_DESC_BASE                 ((volatile struct tx_descriptor *)SB_BUFFER(0, 0x3D00))                 /*         64 each queue    */
...
#define WAN_TX_DESC_BASE(i)                     ((volatile struct tx_descriptor *)SB_BUFFER(2, __ETH_WAN_TX_DESC_BASE(i)))  /*  i < __ETH_WAN_TX_QUEUE_NUM, __ETH_WAN_TX_QUEUE_LEN each queue    */
#define CPU_TO_WAN_SWAP_DESC_BASE               ((volatile struct tx_descriptor *)SB_BUFFER(0, 0x2E80))                 /*         64 each queue    */
#define WAN_RX_DESC_PPE                         0x2600
#define WAN_RX_DESC_BASE                        ((volatile struct tx_descriptor *)SB_BUFFER(0, WAN_RX_DESC_PPE))        /*         64 each queue    */
#ifdef CONFIG_LTQ_PPE_E5_OFFCHIP_BONDING
...
#endif
#define DMA_TX_CH1_DESC_BASE                    (g_eth_wan_mode ? (g_eth_wan_mode == 3 /* ETH WAN */ && g_wanqos_en ? ((volatile struct rx_descriptor *)SB_BUFFER(0, 0x2600)) : DMA_RX_CH1_DESC_BASE) : (volatile struct rx_descriptor *)DMA_TX_CH1_WITH_BONDING)
#define DMA_RX_CH1_DESC_BASE                    ((volatile struct rx_descriptor *)SB_BUFFER(2, 0x2580))                 /*         64 each queue    */
#define DMA_RX_CH2_DESC_BASE                    ((volatile struct rx_descriptor *)SB_BUFFER(0, 0x2F00))                 /*         64 each queue    */
...
#define E1_FRAG_TX_DESC_NB_BASE(i)              ((volatile struct tx_descriptor *)SB_BUFFER(2, E1_FRAG_TX_DESC_NB_PPE(i)))
#define E1_FRAG_RX_DESC_PPE(i)                  (0x3D00 + (i) * 0x40)   //  i < 2
#define E1_FRAG_RX_DESC_BASE(i)                 ((volatile struct rx_descriptor *)SB_BUFFER(2, E1_FRAG_RX_DESC_PPE(i)))
#define B1_RX_LINK_LIST_DESC_PPE                0x4800
#define B1_RX_LINK_LIST_DESC_BASE               ((volatile struct tx_descriptor *)SB_BUFFER(2, B1_RX_LINK_LIST_DESC_PPE))
...
//  need check with hejun
  ...
  #define __CPU_TX_SWAPPER_DROP_PKTS            SB_BUFFER(2, 0x29A8)
  #define __CPU_TX_SWAPPER_DROP_BYTES           SB_BUFFER(2, 0x29A9)
  #define __DSLWAN_FP_SWAPPER_DROP_PKTS         SB_BUFFER(2, 0x29AA)
  #define __DSLWAN_FP_SWAPPER_DROP_BYTES        SB_BUFFER(2, 0x29AB)

  #define __CPU_TXDES_SWAP_RDPTR                SB_BUFFER(2, 0x29AC)
  #define __DSLWAN_FP_RXDES_SWAP_RDPTR          SB_BUFFER(2, 0x29AD)
  #define __DSLWAN_FP_RXDES_DPLUS_WRPTR         SB_BUFFER(2, 0x29AE)

  #define __DSLWAN_TX_PKT_CNT0                  SB_BUFFER(2, 0x29B0)
  #define __DSLWAN_TX_PKT_CNT1                  SB_BUFFER(2, 0x29B1)
  #define __DSLWAN_TX_PKT_CNT2                  SB_BUFFER(2, 0x29B2)
  #define __DSLWAN_TX_PKT_CNT3                  SB_BUFFER(2, 0x29B3)
  #define __DSLWAN_TX_PKT_CNT4                  SB_BUFFER(2, 0x29B4)
  #define __DSLWAN_TX_PKT_CNT5                  SB_BUFFER(2, 0x29B5)
  #define __DSLWAN_TX_PKT_CNT6                  SB_BUFFER(2, 0x29B6)
  #define __DSLWAN_TX_PKT_CNT7                  SB_BUFFER(2, 0x29B7)

  #define __DSLWAN_TXDES_SWAP_PTR0              SB_BUFFER(2, 0x29B8)
  #define __DSLWAN_TXDES_SWAP_PTR1              SB_BUFFER(2, 0x29B9)
  #define __DSLWAN_TXDES_SWAP_PTR2              SB_BUFFER(2, 0x29BA)
  #define __DSLWAN_TXDES_SWAP_PTR3              SB_BUFFER(2, 0x29BB)
  #define __DSLWAN_TXDES_SWAP_PTR4              SB_BUFFER(2, 0x29BC)
  #define __DSLWAN_TXDES_SWAP_PTR5              SB_BUFFER(2, 0x29BD)
  #define __DSLWAN_TXDES_SWAP_PTR6              SB_BUFFER(2, 0x29BE)
  #define __DSLWAN_TXDES_SWAP_PTR7              SB_BUFFER(2, 0x29BF)

  // SB_BUFFER(0x29C0) - SB_BUFFER(0x29C7)
  #define __VLAN_PRI_TO_QID_MAPPING             SB_BUFFER(2, 0x29C0)

  //
  // etx MIB: SB_BUFFER(0x29C8) - SB_BUFFER(0x29CF)
  #define __DSLWAN_TX_THRES_DROP_PKT_CNT0       SB_BUFFER(2, 0x29C8)
  #define __DSLWAN_TX_THRES_DROP_PKT_CNT1       SB_BUFFER(2, 0x29C9)
  #define __DSLWAN_TX_THRES_DROP_PKT_CNT2       SB_BUFFER(2, 0x29CA)
  #define __DSLWAN_TX_THRES_DROP_PKT_CNT3       SB_BUFFER(2, 0x29CB)
  #define __DSLWAN_TX_THRES_DROP_PKT_CNT4       SB_BUFFER(2, 0x29CC)
  #define __DSLWAN_TX_THRES_DROP_PKT_CNT5       SB_BUFFER(2, 0x29CD)
  #define __DSLWAN_TX_THRES_DROP_PKT_CNT6       SB_BUFFER(2, 0x29CE)
  #define __DSLWAN_TX_THRES_DROP_PKT_CNT7       SB_BUFFER(2, 0x29CF)

  #define __CPU_TO_DSLWAN_TX_PKTS               SB_BUFFER(2, 0x29D0)
  #define __CPU_TO_DSLWAN_TX_BYTES              SB_BUFFER(2, 0x29D1)

  #define ACC_ERX_PID                           SB_BUFFER(2, 0x2B00)
  #define ACC_ERX_PORT_TIMES                    SB_BUFFER(2, 0x2B01)
  #define SLL_ISSUED                            SB_BUFFER(2, 0x2B02)
  #define BMC_ISSUED                            SB_BUFFER(2, 0x2B03)
  #define DPLUS_RX_ON                           SB_BUFFER(2, 0x5003)
  #define ISR_IS                                SB_BUFFER(2, 0x5004)

  #define PRESEARCH_RDPTR                       SB_BUFFER(2, 0x2B06)

  #define SLL_ERX_PID                           SB_BUFFER(2, 0x2B04)
  #define SLL_PKT_CNT                           SB_BUFFER(2, 0x2B08)
  #define SLL_RDPTR                             SB_BUFFER(2, 0x2B0A)

  #define EDIT_PKT_CNT                          SB_BUFFER(2, 0x2B0C)
  #define EDIT_RDPTR                            SB_BUFFER(2, 0x2B0E)

  #define DPLUSRX_PKT_CNT                       SB_BUFFER(2, 0x2B10)
  #define DPLUS_RDPTR                           SB_BUFFER(2, 0x2B12)
  ...
  #define SLL_STATE_ROUTER                      4
   ...
   #define PRE_DPLUS_PTR                        SB_BUFFER(2, 0x5001)
   #define DPLUS_PTR                            SB_BUFFER(2, 0x5002)
   #define DPLUS_CNT                            SB_BUFFER(2, 0x5000)
#endif

/*
 *  DPlus Registers
 */
#define DM_RXDB                                 PPE_REG_ADDR(0, 0x0612)
#define DM_RXCB                                 PPE_REG_ADDR(0, 0x0613)
#define DM_RXCFG                                PPE_REG_ADDR(0, 0x0614)
#define DM_RXPGCNT                              PPE_REG_ADDR(0, 0x0615)
#define DM_RXPKTCNT                             PPE_REG_ADDR(0, 0x0616)
#define DS_RXDB                                 PPE_REG_ADDR(0, 0x0710)
#define DS_RXCB                                 PPE_REG_ADDR(0, 0x0711)
#define DS_RXCFG                                PPE_REG_ADDR(0, 0x0712)
#define DS_RXPGCNT                              PPE_REG_ADDR(0, 0x0713)

/*
 *  SAR Registers
 */
#define SAR_MODE_CFG                            PPE_REG_ADDR(2, 0x080A)
#define SAR_RX_CMD_CNT                          PPE_REG_ADDR(2, 0x080B)
#define SAR_TX_CMD_CNT                          PPE_REG_ADDR(2, 0x080C)
#define SAR_RX_CTX_CFG                          PPE_REG_ADDR(2, 0x080D)
#define SAR_TX_CTX_CFG                          PPE_REG_ADDR(2, 0x080E)
#define SAR_TX_CMD_DONE_CNT                     PPE_REG_ADDR(2, 0x080F)
#define SAR_POLY_CFG_SET0                       PPE_REG_ADDR(2, 0x0812)
#define SAR_POLY_CFG_SET1                       PPE_REG_ADDR(2, 0x0813)
#define SAR_POLY_CFG_SET2                       PPE_REG_ADDR(2, 0x0814)
#define SAR_POLY_CFG_SET3                       PPE_REG_ADDR(2, 0x0815)
#define SAR_CRC_SIZE_CFG                        PPE_REG_ADDR(2, 0x0816)

/*
 *  PDMA/EMA Registers
 */
#define PDMA_CFG                                PPE_REG_ADDR(2, 0x0A00)
#define PDMA_RX_CMDCNT                          PPE_REG_ADDR(2, 0x0A01)
#define PDMA_TX_CMDCNT                          PPE_REG_ADDR(2, 0x0A02)
#define PDMA_RX_FWDATACNT                       PPE_REG_ADDR(2, 0x0A03)
#define PDMA_TX_FWDATACNT                       PPE_REG_ADDR(2, 0x0A04)
#define PDMA_RX_CTX_CFG                         PPE_REG_ADDR(2, 0x0A05)
#define PDMA_TX_CTX_CFG                         PPE_REG_ADDR(2, 0x0A06)
#define PDMA_RX_MAX_LEN_REG                     PPE_REG_ADDR(2, 0x0A07)
#define PDMA_RX_DELAY_CFG                       PPE_REG_ADDR(2, 0x0A08)
#define PDMA_INT_FIFO_RD                        PPE_REG_ADDR(2, 0x0A09)
#define PDMA_ISR                                PPE_REG_ADDR(2, 0x0A0A)
#define PDMA_IER                                PPE_REG_ADDR(2, 0x0A0B)
#define PDMA_SUBID                              PPE_REG_ADDR(2, 0x0A0C)
#define PDMA_BAR0                               PPE_REG_ADDR(2, 0x0A0D)
#define PDMA_BAR1                               PPE_REG_ADDR(2, 0x0A0E)

#define SAR_PDMA_RX_CMDBUF_CFG                  PPE_REG_ADDR(2, 0x0F00)
#define SAR_PDMA_TX_CMDBUF_CFG                  PPE_REG_ADDR(2, 0x0F01)
#define SAR_PDMA_RX_FW_CMDBUF_CFG               PPE_REG_ADDR(2, 0x0F02)
#define SAR_PDMA_TX_FW_CMDBUF_CFG               PPE_REG_ADDR(2, 0x0F03)
#define SAR_PDMA_RX_CMDBUF_STATUS               PPE_REG_ADDR(2, 0x0F04)
#define SAR_PDMA_TX_CMDBUF_STATUS               PPE_REG_ADDR(2, 0x0F05)
 ...
 */
#define PP32_FREEZE                             PPE_REG_ADDR(2, 0x0000)
#define PP32_SRST                               PPE_REG_ADDR(2, 0x0020)
/*
  *  SLL Registers
  */
#define SLL_CMD1                                PPE_REG_ADDR(2, 0x900)
#define SLL_CMD0                                PPE_REG_ADDR(2, 0x901)
#define SLL_KEY(x)                              PPE_REG_ADDR(2, 0x910+x)
#define SLL_RESULT                              PPE_REG_ADDR(2, 0x920)
...
//  #define PP32_BRK_CUR_CONTEXT(n)               ((*PP32_BREAKPOINT_REASONS(n) >> 16) & 0x03)
  #define PP32_BRK_CUR_CONTEXT(n)               ((*PP32_CPU_STATUS(n) >> 8) & 0x03)
 ...
 */
#define CDM_CFG                                 PPE_REG_ADDR(2, 0x0100)
 ...
 */
#define MBOX_IGU0_ISRS                          PPE_REG_ADDR(0, 0x0200)
#define MBOX_IGU0_ISRC                          PPE_REG_ADDR(0, 0x0201)
#define MBOX_IGU0_ISR                           PPE_REG_ADDR(0, 0x0202)
#define MBOX_IGU0_IER                           PPE_REG_ADDR(0, 0x0203)

/*
 *  Mailbox IGU1 Registers
 */
#define MBOX_IGU1_ISRS                          PPE_REG_ADDR(0, 0x0204)
#define MBOX_IGU1_ISRC                          PPE_REG_ADDR(0, 0x0205)
#define MBOX_IGU1_ISR                           PPE_REG_ADDR(0, 0x0206)
#define MBOX_IGU1_IER                           PPE_REG_ADDR(0, 0x0207)

/*
 *  RTHA/TTHA Registers
 */
#define RFBI_CFG                                PPE_REG_ADDR(2, 0x0400)
#define RBA_CFG0                                PPE_REG_ADDR(2, 0x0404)
#define RBA_CFG1                                PPE_REG_ADDR(2, 0x0405)
#define RCA_CFG0                                PPE_REG_ADDR(2, 0x0408)
#define RCA_CFG1                                PPE_REG_ADDR(2, 0x0409)
#define RDES_CFG0                               PPE_REG_ADDR(2, 0x040C)
#define RDES_CFG1                               PPE_REG_ADDR(2, 0x040D)
#define SFSM_STATE0                             PPE_REG_ADDR(2, 0x0410)
#define SFSM_STATE1                             PPE_REG_ADDR(2, 0x0411)
#define SFSM_DBA0                               PPE_REG_ADDR(2, 0x0412)
#define SFSM_DBA1                               PPE_REG_ADDR(2, 0x0413)
#define SFSM_CBA0                               PPE_REG_ADDR(2, 0x0414)
#define SFSM_CBA1                               PPE_REG_ADDR(2, 0x0415)
#define SFSM_CFG0                               PPE_REG_ADDR(2, 0x0416)
#define SFSM_CFG1                               PPE_REG_ADDR(2, 0x0417)
#define SFSM_PGCNT0                             PPE_REG_ADDR(2, 0x041C)
#define SFSM_PGCNT1                             PPE_REG_ADDR(2, 0x041D)
#define FFSM_DBA0                               PPE_REG_ADDR(2, 0x0508)
#define FFSM_DBA1                               PPE_REG_ADDR(2, 0x0509)
#define FFSM_CFG0                               PPE_REG_ADDR(2, 0x050A)
#define FFSM_CFG1                               PPE_REG_ADDR(2, 0x050B)
#define FFSM_IDLE_HEAD_BC0                      PPE_REG_ADDR(2, 0x050E)
#define FFSM_IDLE_HEAD_BC1                      PPE_REG_ADDR(2, 0x050F)
#define FFSM_PGCNT0                             PPE_REG_ADDR(2, 0x0514)
#define FFSM_PGCNT1                             PPE_REG_ADDR(2, 0x0515)

#define SFSM_DBA(i)                             ((volatile struct SFSM_dba *)  PPE_REG_ADDR(2, 0x0412 + (i)))
#define SFSM_CBA(i)                             ((volatile struct SFSM_cba *)  PPE_REG_ADDR(2, 0x0414 + (i)))
#define SFSM_CFG(i)                             ((volatile struct SFSM_cfg *)  PPE_REG_ADDR(2, 0x0416 + (i)))
#define SFSM_PGCNT(i)                           ((volatile struct SFSM_pgcnt *)PPE_REG_ADDR(2, 0x041C + (i)))
#define FFSM_DBA(i)                             ((volatile struct FFSM_dba *)  PPE_REG_ADDR(2, 0x0508 + (i)))
#define FFSM_CFG(i)                             ((volatile struct FFSM_cfg *)  PPE_REG_ADDR(2, 0x050A + (i)))
#define FFSM_PGCNT(i)                           ((volatile struct FFSM_pgcnt *)PPE_REG_ADDR(2, 0x0514 + (i)))

/*
 *  PPE TC Logic Registers (partial)
 */
#define DREG_A_VERSION                          PPE_REG_ADDR(2, 0x0D00)
#define DREG_A_CFG                              PPE_REG_ADDR(2, 0x0D01)
#define DREG_AT_CTRL                            PPE_REG_ADDR(2, 0x0D02)
#define DREG_AT_CB_CFG0                         PPE_REG_ADDR(2, 0x0D03)
#define DREG_AT_CB_CFG1                         PPE_REG_ADDR(2, 0x0D04)
#define DREG_AR_CTRL                            PPE_REG_ADDR(2, 0x0D08)
#define DREG_AR_CB_CFG0                         PPE_REG_ADDR(2, 0x0D09)
#define DREG_AR_CB_CFG1                         PPE_REG_ADDR(2, 0x0D0A)
#define DREG_A_UTPCFG                           PPE_REG_ADDR(2, 0x0D0E)
#define DREG_A_STATUS                           PPE_REG_ADDR(2, 0x0D0F)
#define DREG_AT_CFG0                            PPE_REG_ADDR(2, 0x0D20)
#define DREG_AT_CFG1                            PPE_REG_ADDR(2, 0x0D21)
#define DREG_AT_FB_SIZE0                        PPE_REG_ADDR(2, 0x0D22)
#define DREG_AT_FB_SIZE1                        PPE_REG_ADDR(2, 0x0D23)
#define DREG_AT_CELL0                           PPE_REG_ADDR(2, 0x0D24)
#define DREG_AT_CELL1                           PPE_REG_ADDR(2, 0x0D25)
#define DREG_AT_IDLE_CNT0                       PPE_REG_ADDR(2, 0x0D26)
#define DREG_AT_IDLE_CNT1                       PPE_REG_ADDR(2, 0x0D27)
#define DREG_AT_IDLE0                           PPE_REG_ADDR(2, 0x0D28)
#define DREG_AT_IDLE1                           PPE_REG_ADDR(2, 0x0D29)
#define DREG_AR_CFG0                            PPE_REG_ADDR(2, 0x0D60)
#define DREG_AR_CFG1                            PPE_REG_ADDR(2, 0x0D61)
#define DREG_AR_CELL0                           PPE_REG_ADDR(2, 0x0D68)
#define DREG_AR_CELL1                           PPE_REG_ADDR(2, 0x0D69)
#define DREG_AR_IDLE_CNT0                       PPE_REG_ADDR(2, 0x0D6A)
#define DREG_AR_IDLE_CNT1                       PPE_REG_ADDR(2, 0x0D6B)
#define DREG_AR_AIIDLE_CNT0                     PPE_REG_ADDR(2, 0x0D6C)
#define DREG_AR_AIIDLE_CNT1                     PPE_REG_ADDR(2, 0x0D6D)
#define DREG_AR_BE_CNT0                         PPE_REG_ADDR(2, 0x0D6E)
#define DREG_AR_BE_CNT1                         PPE_REG_ADDR(2, 0x0D6F)
#define DREG_AR_HEC_CNT0                        PPE_REG_ADDR(2, 0x0D70)
#define DREG_AR_HEC_CNT1                        PPE_REG_ADDR(2, 0x0D71)
#define DREG_AR_IDLE0                           PPE_REG_ADDR(2, 0x0D74)
#define DREG_AR_IDLE1                           PPE_REG_ADDR(2, 0x0D75)
#define DREG_AR_OVDROP_CNT0                     PPE_REG_ADDR(2, 0x0D98)
#define DREG_AR_OVDROP_CNT1                     PPE_REG_ADDR(2, 0x0D99)
#define DREG_AR_CERRN_CNT0                      PPE_REG_ADDR(2, 0x0DA0)
#define DREG_AR_CERRN_CNT1                      PPE_REG_ADDR(2, 0x0DA1)
#define DREG_AR_CERRNP_CNT0                     PPE_REG_ADDR(2, 0x0DA2)
#define DREG_AR_CERRNP_CNT1                     PPE_REG_ADDR(2, 0x0DA3)
#define DREG_AR_CVN_CNT0                        PPE_REG_ADDR(2, 0x0DA4)
#define DREG_AR_CVN_CNT1                        PPE_REG_ADDR(2, 0x0DA5)
#define DREG_AR_CVNP_CNT0                       PPE_REG_ADDR(2, 0x0DA6)
#define DREG_AR_CVNP_CNT1                       PPE_REG_ADDR(2, 0x0DA7)
#define DREG_B0_LADR                            PPE_REG_ADDR(2, 0x0DA8)
#define DREG_B1_LADR                            PPE_REG_ADDR(2, 0x0DA9)
...
#ifdef CONFIG_LTQ_PPE_E5_OFFCHIP_BONDING
  // ARC Cross PCI
  #define PCI_ADDR_BASE                         (g_ppe_base_addr == LTQ_PPE_ORG(0) ? 0 : g_pci_dev_ppe_addr_off)
#else
...
#define IFX_PMU                                 KSEG1ADDR(PCI_ADDR_BASE + IFX_PMU_ORG)
...
static int ptm_hard_start_xmit_b(struct sk_buff *, struct net_device *);    //  bonding
...
static ssize_t dsl_proc_write_status_seq(struct file *, const char __user *, size_t, loff_t *);
...
static ssize_t proc_write_wanmib_seq(struct file *, const char __user *, size_t, loff_t *);
...
#endif
  static int proc_read_gamma(struct seq_file *, void *);
...
static ssize_t proc_write_dev_seq(struct file *, const char __user *, size_t, loff_t *);
#endif

#if defined(DEBUG_BONDING_PROC) && DEBUG_BONDING_PROC
static int proc_read_bonding(struct seq_file *, void *);
static ssize_t proc_write_bonding_seq(struct file *, const char __user *, size_t, loff_t *);
#endif
...
#endif
static int proc_read_gamma_seq_open(struct inode *, struct file *);
 ...
 *  Global Functions
 */
static int dsl_showtime_enter(const unsigned char,struct port_cell_info *, void *);
static int dsl_showtime_exit(const unsigned char );
...
//  EXPORT_SYMBOL(g_pci_dev_ppe_addr_off);
  unsigned int g_ppe_base_addr = LTQ_PPE_ORG(0);
...
static void ptm_setup(struct net_device *dev)
{
    ...
    dev->open            = ptm_open;
    dev->stop            = ptm_stop;
    dev->hard_start_xmit = g_dsl_bonding ? ptm_hard_start_xmit_b : ptm_hard_start_xmit;
    dev->do_ioctl        = ptm_ioctl;
    dev->tx_timeout      = ptm_tx_timeout;
  #else
    if ( g_dsl_bonding )
        g_ptm_netdev_ops.ndo_start_xmit = ptm_hard_start_xmit_b;
    dev->netdev_ops      = &g_ptm_netdev_ops;
  #endif
    dev->watchdog_timeo  = ETH_WATCHDOG_TIMEOUT;
#endif
    priv->dev_id         = PPA_PORT_PTM;
...
{
    ASSERT(((struct eth_priv_data *)ifx_eth_fw_netdev_priv(dev))->dev_id == PPA_PORT_PTM, "incorrect device");
...
static int ptm_hard_start_xmit(struct sk_buff *skb, struct net_device *dev)
{
    ...
    ASSERT(priv->dev_id == PPA_PORT_PTM, "incorrect device");
...
static int ptm_hard_start_xmit_b(struct sk_buff *skb, struct net_device *dev)
{
    int qid;
...
static INLINE int eth_xmit(struct sk_buff *skb, int port, int ch, int spid, int class)
{
    ...
    if ( port < NUM_ENTITY(g_eth_net_dev) || port == 7 )
    {
        dev->trans_start = jiffies;
...
#if defined(DEBUG_DUMP_SKB) && DEBUG_DUMP_SKB
    if ( (g_dbg_enable & DBG_ENABLE_MASK_DUMP_SKB_TX) )
...
static INLINE int dma_rx_int_handler(struct dma_device_info *dma_dev)
{
    ...
    if ( header->acc_done && header->dest_list )        //  acc_done == 1 && dest_list != 0
    {
        ...
        else if ( (header->dest_list & (1 << 7)) )      //  7 - ptm0
        {
            if ( g_dsl_bonding )
            {
                skb->priority = g_wan_queue_class_map[header->qid & 0x07] | 0x08;   //  QId derived from class value will overwrite QId from action table
                ptm_hard_start_xmit_b(skb, g_ptm_net_dev[0]);
            }
            else
            {
                skb->cb[13] = 0x5A; //  magic number indicating forcing QId (e.g. directpath)
...
#ifdef MODULE
//    printk("\nInside reset_ppe ...... ");
    IFX_REG_W32_MASK(0, BIT(3), RCU_RST_REQ);
    udelay(1000);
    IFX_REG_W32_MASK(0, BIT(11), RCU_RST_REQ);
    udelay(1000);
...
static INLINE int pp32_start(int pp32, int is_e1)
{
    ...
    /*  download firmware   */
    if ( is_e1 )
        ret = pp32_download_code(pp32, vr9_e1_fw_code, sizeof(vr9_e1_fw_code) / sizeof(*vr9_e1_fw_code), vr9_e1_fw_data, sizeof(vr9_e1_fw_data) / sizeof(*vr9_e1_fw_data));
    else
        ret = pp32_download_code(pp32, vr9_d5_fw_code, sizeof(vr9_d5_fw_code) / sizeof(*vr9_d5_fw_code), vr9_d5_fw_data, sizeof(vr9_d5_fw_data) / sizeof(*vr9_d5_fw_data));
    if ( ret != PPA_SUCCESS ){
        return ret;
    }
...
static INLINE int init_local_variables(void)
{
    ...
    g_dsl_bonding = g_eth_wan_mode == 0 && dsl_bonding >= 0 && dsl_bonding <= 2 ? dsl_bonding : 0;  //  by default disable bonding
#ifdef CONFIG_LTQ_PPE_E5_OFFCHIP_BONDING
    if ( g_dsl_bonding == 2 )   //  off chip bonding
    {
        ASSERT(pci_ppe_addr != 0, "Off chip bonding requires PPE base address of system slave!");
        g_slave_ppe_base_addr = CPHYSADDR(pci_ppe_addr);
        g_pci_dev_ppe_addr_off = (unsigned int)CPHYSADDR(g_slave_ppe_base_addr - LTQ_PPE_ORG(0));
        ASSERT(bm_addr != 0, "Off chip bonding requires DDR base address of bonding master!");
        g_bm_addr = KSEG1ADDR(bm_addr);
        ASSERT(pci_ddr_addr != 0, "Off chip bonding requires DDR base address of system slave!");
        g_pci_host_ddr_addr = KSEG1ADDR((unsigned int)pci_ddr_addr | (CPHYSADDR(g_bm_addr) - 0x01000000));
        ASSERT(pci_bm_ppe_addr != 0, "Off chip bonding requires PPE INT register address of bonding slave!");
        g_bm_ppe_int_addr = KSEG1ADDR(pci_bm_ppe_addr | (0xD220 << 2));
    }
    else
        g_slave_ppe_base_addr = LTQ_PPE_ORG(0);
#endif
    ...
    for ( i = 0; i < 2; i++ )
    {
        ...
        tx_num_q = (g_wan_itf & (1 << i)) && (g_eth_wan_mode == 3 /* ETH WAN */ && g_wanqos_en) ? __ETH_WAN_TX_QUEUE_NUM : __ETH_VIRTUAL_TX_QUEUE_NUM;
        q_step = tx_num_q - 1;
...
static INLINE void init_ptm_tables(void)
{
    ...
    *TX_BC_CFG(1) = tx_bc_cfg;
    ...
    if ( g_dsl_bonding == 2 )
        *FP_QID_BASE_PDMA_BAR = (unsigned int)SB_BUFFER(1, 0x5000);
...
static INLINE void init_ptm_bonding_tables(void)
{
    ...
    else
    {
        ...
        *SB_BUFFER(0, FRAG_READY_NOTICE) = 1;

        // IGU4: linu up/down status (i.e., in showtime, not in showtime)
        // IGU5: gif on_off status
        up_addr   = (unsigned int)SB_BUFFER(1, 0x7218);
        down_addr = (unsigned int)SB_BUFFER(1, 0x7219);
        ...
        *SB_BUFFER(1, FRAG_READY_NOTICE) = 1;
...
//    unsigned int pdata = DMA_ALIGNED(CPHYSADDR(g_bm_addr) + (DMA_TX_CH1_DESC_NUM + DMA_RX_CH1_DESC_NUM) * 2 * sizeof(unsigned int));
    ...
    e1_bar = (unsigned int)SB_BUFFER(1, 0x3800);
...
{
    if ( ITF_MIB_TBL(7)->ig_fast_brg_bytes != g_dsl_ig_fast_brg_bytes
        || ITF_MIB_TBL(7)->ig_fast_rt_ipv4_bytes != g_dsl_ig_fast_rt_ipv4_bytes
        || ITF_MIB_TBL(7)->ig_fast_rt_ipv6_bytes != g_dsl_ig_fast_rt_ipv6_bytes
        || ITF_MIB_TBL(7)->ig_cpu_bytes != g_dsl_ig_cpu_bytes
        || ITF_MIB_TBL(7)->eg_fast_pkts != g_dsl_eg_fast_pkts )
    {
        g_dsl_ig_fast_brg_bytes     = ITF_MIB_TBL(7)->ig_fast_brg_bytes;
        g_dsl_ig_fast_rt_ipv4_bytes = ITF_MIB_TBL(7)->ig_fast_rt_ipv4_bytes;
        g_dsl_ig_fast_rt_ipv6_bytes = ITF_MIB_TBL(7)->ig_fast_rt_ipv6_bytes;
...
static int print_fw_ver(char *buf, int buf_len)
{
    ...
    for ( i = 0; i < NUM_ENTITY(g_fw_ver); i++ )
    {
        ...
        len += snprintf(buf + len, buf_len - len, "  Version ID: %d.%d.%d.%d.%d\n", (int)g_fw_ver[i].family, (int)g_fw_ver[i].package, (int)g_fw_ver[i].major, (int)g_fw_ver[i].middle,(int)g_fw_ver[i].minor);
        ...
        if ( g_fw_ver[i].package >= NUM_ENTITY(fw_ver_package_str) )
            len += snprintf(buf + len, buf_len - len, "  FW Package: reserved - %d\n", (int)g_fw_ver[i].package);
        else
            len += snprintf(buf + len, buf_len - len, "  FW Package: %s\n", fw_ver_package_str[g_fw_ver[i].package]);

        len += snprintf(buf + len, buf_len - len,     "  Release   : %d.%d.%d\n", (int)g_fw_ver[i].major, (int)g_fw_ver[i].middle,(int)g_fw_ver[i].minor);
    }
...
#if (defined(DEBUG_FW_PROC) && DEBUG_FW_PROC) || (defined(DEBUG_BONDING_PROC) && DEBUG_BONDING_PROC)
...
static int dsl_proc_read_status(struct seq_file *seq, void *v)
{
    ...
    if ( g_dsl_bonding)
    {
        seq_printf(seq, BOND_CONF->bond_mode == L1_PTM_TC_BOND_MODE ? "Bonding Mode: PTM TC\n" : "Bonding Mode: ETH Trunk\n");
    }
...
static ssize_t dsl_proc_write_status_seq(struct file *file, const char __user *buf, size_t count, loff_t *data)
{
    char *p1, *p2;
    int len;
    int colon;
    ...
    {
        for ( i = 0; i < NUM_ENTITY(env_var_str) && strincmp(p1, env_var_str[i], strlen(env_var_str[i])) != 0; i++ );
        switch ( i )
        {
        case 0: //  help
            printk("Usage:\n");
        ...
        case 4: //  DSL_BONDING_STATUS
            if ( g_dsl_bonding )
            {
                ...
                {
                    if ( stricmp(p1, "inactive") == 0 )
                        switch_to_eth_trunk();
                    else if ( stricmp(p1, "active") == 0 )
        ...
        case 5: //  DSL_INTERFACE_STATUS
            if ( line >= 0 )
            {
                p1 = p2;
                colon = 1;
                if ( get_token(&p1, &p2, &len, &colon) && stricmp(p1, "down") == 0 && g_line_showtime[line] != 0 )
                {
    ...
    if ( line >= 0 )
    {
        ...
        else
        {
            if ( upstr )
            {
                ...
                g_showtime[line] = 1; //  equivalent to dsl_showtime_enter
            }
            if ( downstr )
            {
                for ( i = 0; i < BEARER_CHANNEL_PER_LINE; i++ )
...
static struct file_operations g_proc_file_status_seq_fops = {
    ...
    .read       = seq_read,
    .write      = dsl_proc_write_status_seq,
    .llseek     = seq_lseek,
...
static struct file_operations g_proc_file_gamma_seq_fops = {
    .owner      = THIS_MODULE,
    .open       = proc_read_gamma_seq_open,
    .read       = seq_read,
    .llseek     = seq_lseek,
    .release    = single_release,
};

static int proc_read_gamma_seq_open(struct inode *inode, struct file *file)
{
    return single_open(file, proc_read_gamma, NULL);
}
...
static void ppa_proc_reg(struct proc_entry_cfg *proc_entry)
{
    ...
    for ( i = 0; proc_entry[i].name != NULL; i++ ) {
        if ( strcmp(proc_entry[i].name, "dsl_tc") == 0 )
    res  = proc_create("status",S_IRUGO|S_IWUSR, proc_entry[i].proc_dir, &g_proc_file_status_seq_fops);
    }
    ...
    res  = proc_create("wanmib",S_IRUGO|S_IWUSR, proc_dir, &g_proc_file_wanmib_seq_fops);
#if defined(DEBUG_FIRMWARE_TABLES_PROC) && DEBUG_FIRMWARE_TABLES_PROC
    ...
    if(!g_eth_wan_mode)
    {
    	res  = proc_create("gamma",S_IRUGO|S_IWUSR, proc_dir, &g_proc_file_gamma_seq_fops);
    }
#if defined(DEBUG_MIRROR_PROC) && DEBUG_MIRROR_PROC
    ...
    if(g_dsl_bonding == 2)
    {
    	res  = proc_create("dev",S_IRUGO|S_IWUSR, proc_dir, &g_proc_file_dev_seq_fops);
    }
#endif
#if defined(DEBUG_BONDING_PROC) && DEBUG_BONDING_PROC
    res  = proc_create("bonding",S_IRUGO|S_IWUSR, proc_dir, &g_proc_file_bonding_seq_fops);
#endif
...
static INLINE void proc_file_create(void)
{
    ...
    for(i = 0; ppa_proc_entry[i].name != NULL; i ++){
        if(g_eth_wan_mode && !g_wanqos_en && strcmp(ppa_proc_entry[i].name, "qos") == 0){
            ppa_proc_entry[i].is_enable = 0;
        }
        else if(!g_ipv6_acc_en && strcmp(ppa_proc_entry[i].name, "ipv6_ip") == 0){
            ppa_proc_entry[i].is_enable = 0;
        }
        else if(g_eth_wan_mode && strcmp(ppa_proc_entry[i].name, "gamma") == 0){
            ppa_proc_entry[i].is_enable = 0;
        }
#ifdef CONFIG_LTQ_PPE_E5_OFFCHIP_BONDING
        else if(g_dsl_bonding != 2 && strcmp(ppa_proc_entry[i].name, "dev") == 0){
            ppa_proc_entry[i].is_enable = 0;
        }
#endif
    }
...
static void clear_mib_counter(unsigned int mib_itf )
{
    ...
    if ( (mib_itf & g_wan_itf) )
    {
        for ( i = 0; i < 8; i++ )
        {
            void *ptmp = (void *)WAN_TX_MIB_TABLE(i);
            memset(ptmp, 0, sizeof(struct wan_tx_mib_table));
        }
    }
}
...
static inline unsigned long sb_addr_to_fpi_addr_convert(unsigned long sb_addr)
{
    if ( sb_addr <= PP32_SB_ADDR_END) {
        return (unsigned long ) SB_BUFFER(2, sb_addr);
    }
    else {
        return sb_addr;
    }
...
static void fwdbg_read_ethbuf(char **tokens, int token_num)
{
    ...
    dbase = (volatile unsigned int *)SB_BUFFER( 2, ( ( struct dmrx_dba * )DM_RXDB)->dbase + 0x2000 );
    cbase = (volatile unsigned int *)SB_BUFFER( 2, ( ( struct dmrx_cba * )DM_RXCB)->cbase + 0x2000);
...
static void fwdbg_read_cb(char **tokens, int token_num)
{
    ...
    dbase0 = (volatile unsigned int *)SB_BUFFER( 2, FFSM_DBA(0)->dbase + 0x2000);
...
#if defined(DEBUG_BONDING_PROC) && DEBUG_BONDING_PROC
  #if 0
static void init_ds_des_array(void)
{
    if (g_dsl_bonding != 2)
        return;

    {
        ...
        memcpy(saved_ds_des_array, (void *)DMA_TX_CH1_DESC_BASE, sizeof(struct rx_descriptor)* DMA_TX_CH1_DESC_NUM);
        RESTORE_PPE_BASE(saved_ppe_base_addr);
    }
    {
        SAVE_AND_SWITCH_PPE_BASE_TO_BM (saved_ppe_base_addr);
        memcpy(&saved_ds_des_array[DMA_TX_CH1_DESC_NUM], (void *)E1_FRAG_RX_DESC_BASE(0), sizeof(struct rx_descriptor)* E1_FRAG_RX_DESC_NUM * 2);
        memcpy(&saved_ds_des_array[DMA_TX_CH1_DESC_NUM + E1_FRAG_RX_DESC_NUM * 2], (void *)B1_RX_LINK_LIST_DESC_BASE, sizeof(struct rx_descriptor)* B1_RX_LINK_LIST_DESC_NUM );

        memcpy(&saved_us_des_array, (void *)US_BOND_PKT_DES_BASE(0), sizeof(struct rx_descriptor)* 512 );
        memcpy(&saved_us_des_array[512],  (void *)DMA_RX_CH1_DESC_BASE, sizeof(struct rx_descriptor)* 64 );
        RESTORE_PPE_BASE(saved_ppe_base_addr);
    }
...
#define __PF_TEST_CMD                      ((volatile PDMA_PF_TEST_CMD *) SB_BUFFER(2, 0x51AC))
#define __RW_CYCLES                         SB_BUFFER(2, 0x51AD)

#define __RW_PERF_TEST_PDMA_CMD0            SB_BUFFER(2, 0x51AE)
#define __RW_PERF_TEST_PDMA_CMD1            SB_BUFFER(2, 0x51AF)
...
void check_ds_ll_list(volatile struct DS_BOND_GIF_LL_CTXT * p_ll_ctxt, unsigned char * leading)
{
    ...
    while(des_num > 1) {
        sb_curr_des_ptr = ((volatile struct DS_BOND_GIF_LL_DES *)SB_BUFFER(2, sb_curr_des_ptr))->next_des_ptr;
        des_num --;
    }
...
static int print_fw_ver_seq(struct seq_file *seq)
{
    ...
    for ( i = 0; i < NUM_ENTITY(g_fw_ver); i++ )
    {
        ...
        seq_printf(seq, "PPE %d firmware info:\n", i);
...
static int proc_read_mib(struct seq_file *seq, void *v)
{
    ...
    char *row_name[] = {"ig_fast_brg_pkts", "ig_fast_brg_bytes", "ig_fast_rt_ipv4_udp_pkts", "ig_fast_rt_ipv4_tcp_pkts",
                        "ig_fast_rt_ipv4_mc_pkts", "ig_fast_rt_ipv4_bytes", "ig_fast_rt_ipv6_udp_pkts",
                        "ig_fast_rt_ipv6_tcp_pkts", "ig_fast_rt_ipv6_mc_pkts", "ig_fast_rt_ipv6_bytes", NULL,
                        "ig_cpu_pkts", "ig_cpu_bytes", "ig_drop_pkts", "ig_drop_bytes", "eg_fast_pkts"};
    ...
    seq_printf(seq, "  Driver  (eth0, eth1, ptm0)\n");
...
static int proc_read_wanmib(struct seq_file *seq, void *v)
{
    ...
    seq_printf(seq, "RX (Bearer Channels):\n");
    seq_printf(seq, "   wrx_bc_overdrop:");
    for ( i = 0; i < 2; i++ )
    {
        if ( i != 0 )
            seq_printf(seq, ",             ");
        seq_printf(seq, "%10u", IFX_REG_R32(wrx_bc_overdrop_cnt[i]) - last_wrx_bc_overdrop_cnt[PPE_ID][i]);
    }
    seq_printf(seq, "\n");
    ...
    for ( i = 0; i < 2; i++ )
    {
        if ( i != 0 )
            seq_printf(seq, ",             ");
        seq_printf(seq, "%10u", IFX_REG_R32(RECEIVE_NON_IDLE_CELL_CNT(i)));
    }
    seq_printf(seq, "\n");
    ...
    for ( i = 0; i < 2; i++ )
    {
        if ( i != 0 )
            seq_printf(seq, ",             ");
        seq_printf(seq, "%10u", IFX_REG_R32(RECEIVE_IDLE_CELL_CNT(i)));
    }
    seq_printf(seq, "\n");

    seq_printf(seq, "RX (Gamma Interfaces):\n");
    seq_printf(seq, "  wrx_total_pdu:   ");
    for ( i = 0; i < 4; i++ )
    {
        if ( i != 0 )
            seq_printf(seq, ", ");
        seq_printf(seq, "%10u", IFX_REG_R32(wrx_total_pdu[i]) - last_wrx_total_pdu[PPE_ID][i]);
    }
    seq_printf(seq, "\n");
    ...
    for ( i = 0; i < 4; i++ )
    {
        if ( i != 0 )
            seq_printf(seq, ", ");
        seq_printf(seq, "%10u", WAN_RX_MIB_TABLE(i)->wrx_dropdes_pdu);
    }
    seq_printf(seq, "\n");
    ...
    for ( i = 0; i < 4; i++ )
    {
        if ( i != 0 )
            seq_printf(seq, ", ");
        seq_printf(seq, "%10u", IFX_REG_R32(wrx_cv_cw_cnt[i]) - last_wrx_cv_cw_cnt[PPE_ID][i]);
    }
    seq_printf(seq, "\n");
    ...
    for ( i = 0; i < 4; i++ )
    {
        if ( i != 0 )
            seq_printf(seq, ", ");
        seq_printf(seq, "%10u", IFX_REG_R32(wrx_crc_err_pdu[i]) - last_wrx_crc_error_total_pdu[PPE_ID][i]);
    }
    seq_printf(seq, "\n");
    ...
    for ( i = 0; i < 4; i++ )
    {
        if ( i != 0 )
            seq_printf(seq, ", ");
        seq_printf(seq, "%10u", WAN_RX_MIB_TABLE(i)->wrx_total_bytes);
    }
    seq_printf(seq, "\n");

    seq_printf(seq, "TX (Bearer Channels):\n");
    seq_printf(seq, "  total_tx_cw:     %10u,             %10u\n", IFX_REG_R32(TRANSMIT_CELL_CNT(0)), IFX_REG_R32(TRANSMIT_CELL_CNT(1)));

    seq_printf(seq, "TX (QoS Queues):\n");
    seq_printf(seq, "  wrx_total_pdu:           ");
    for ( i = 0; i < 8; i++ )
    {
        if ( i != 0 )
            seq_printf(seq, ", ");
        seq_printf(seq, "%10u", WAN_TX_MIB_TABLE(i)->wrx_total_pdu);
    }
    seq_printf(seq, "\n");
    seq_printf(seq, "  wrx_total_bytes:         ");
    for ( i = 0; i < 8; i++ )
    {
        if ( i != 0 )
            seq_printf(seq, ", ");
        seq_printf(seq, "%10u", WAN_TX_MIB_TABLE(i)->wrx_total_bytes);
    }
    seq_printf(seq, "\n");
    seq_printf(seq, "  wtx_total_pdu:           ");
    for ( i = 0; i < 8; i++ )
    {
        if ( i != 0 )
            seq_printf(seq, ", ");
        seq_printf(seq, "%10u", WAN_TX_MIB_TABLE(i)->wtx_total_pdu);
    }
    seq_printf(seq, "\n");
    seq_printf(seq, "  wtx_total_bytes:         ");
    for ( i = 0; i < 8; i++ )
    {
        if ( i != 0 )
            seq_printf(seq, ", ");
        seq_printf(seq, "%10u", WAN_TX_MIB_TABLE(i)->wtx_total_bytes);
    }
    seq_printf(seq, "\n");
    seq_printf(seq, "  wtx_cpu_drop_small_pdu:  ");
    for ( i = 0; i < 8; i++ )
    {
        if ( i != 0 )
            seq_printf(seq, ", ");
        seq_printf(seq, "%10u", WAN_TX_MIB_TABLE(i)->wtx_cpu_drop_small_pdu);
    }
    seq_printf(seq, "\n");
    seq_printf(seq, "  wtx_cpu_drop_pdu:        ");
    for ( i = 0; i < 8; i++ )
    {
        if ( i != 0 )
            seq_printf(seq, ", ");
        seq_printf(seq, "%10u", WAN_TX_MIB_TABLE(i)->wtx_cpu_drop_pdu);
    }
    seq_printf(seq, "\n");
    seq_printf(seq, "  wtx_fast_drop_small_pdu: ");
    for ( i = 0; i < 8; i++ )
    {
        if ( i != 0 )
            seq_printf(seq, ", ");
        seq_printf(seq, "%10u", WAN_TX_MIB_TABLE(i)->wtx_fast_drop_small_pdu);
    }
    seq_printf(seq, "\n");
    seq_printf(seq, "  wtx_fast_drop_pdu:       ");
    for ( i = 0; i < 8; i++ )
    {
        if ( i != 0 )
            seq_printf(seq, ", ");
        seq_printf(seq, "%10u", WAN_TX_MIB_TABLE(i)->wtx_fast_drop_pdu);
    }
    seq_printf(seq, "\n");
...
static ssize_t proc_write_wanmib_seq(struct file *file, const char __user *buf, size_t count, loff_t *data)
{
    char str[2048];
    char *p;
    int len, rlen;
                ...
                for ( i = 0; i < NUM_ENTITY(dbg_enable_mask_str); i++ )
                    if ( strincmp(p, dbg_enable_mask_str[i], dbg_enable_mask_str_len[i]) == 0 )
                    {
                        if ( f_enable > 0 )
                        {
                            ...
                            if ( g_dsl_bonding && dbg_enable_mask[i >> 1] == DBG_ENABLE_MASK_MAC_SWAP )
                            {
                                *SB_BUFFER(0, 0x7DC0) = 3;
                                *SB_BUFFER(0, 0x7DD0) = 3;
#ifdef CONFIG_LTQ_PPE_E5_OFFCHIP_BONDING
                                if ( g_dsl_bonding == 2 )
                                {
                                    *SB_BUFFER(0, 0x7DC0) = 3;
                        ...
                        else
                        {
                            ...
                            if ( g_dsl_bonding && dbg_enable_mask[i >> 1] == DBG_ENABLE_MASK_MAC_SWAP )
                            {
                                *SB_BUFFER(0, 0x7DC0) = 0;
                                *SB_BUFFER(0, 0x7DD0) = 0;
#ifdef CONFIG_LTQ_PPE_E5_OFFCHIP_BONDING
                                if ( g_dsl_bonding == 2 )
                                {
                                    *SB_BUFFER(0, 0x7DC0) = 0;
...
static int proc_read_fw(struct seq_file *seq, void *v)
{
...

    {
        ...
        seq_printf(seq, "SFSM Status:  bc0                         bc1  \n\n");
        seq_printf(seq, "Local State = %d [%-22s], %d [%-22s]\n"
       ...
       seq_printf(seq, "  dbase     = 0x%04x  ( 0x%08x )    , 0x%04x  ( 0x%08x )\n",
                SFSM_DBA(0)->dbase, (unsigned int )SB_BUFFER(2, SFSM_DBA(0)->dbase + 0x2000),
                SFSM_DBA(1)->dbase, (unsigned int )SB_BUFFER(2, SFSM_DBA(1)->dbase + 0x2000)  );
        seq_printf(seq, "  cbase     = 0x%04x  ( 0x%08x )    , 0x%04x  ( 0x%08x )\n",
                SFSM_CBA(0)->cbase, (unsigned int )SB_BUFFER(2, SFSM_CBA(0)->cbase + 0x2000),
                SFSM_CBA(1)->cbase, (unsigned int )SB_BUFFER(2, SFSM_CBA(1)->cbase + 0x2000));
        seq_printf(seq, "  sen       = %-26d, %d\n", SFSM_CFG(0)->sen, SFSM_CFG(1)->sen );
        seq_printf(seq, "  idlekeep  = %-26d, %d\n", SFSM_CFG(0)->idlekeep, SFSM_CFG(1)->idlekeep );
        seq_printf(seq, "  pnum      = %-26d, %d\n", SFSM_CFG(0)->pnum, SFSM_CFG(1)->pnum );
        seq_printf(seq, "  pptr      = %-26d, %d\n", SFSM_PGCNT(0)->pptr, SFSM_PGCNT(1)->pptr);
        seq_printf(seq, "  upage     = %-26d, %d\n", SFSM_PGCNT(0)->upage, SFSM_PGCNT(1)->upage);
        seq_printf(seq, "  rdptr     = %-26d, %d\n", RX_BC_CFG(0)->rx_cw_rdptr, RX_BC_CFG(1)->rx_cw_rdptr );
        seq_printf(seq, "\n");


        seq_printf(seq, "FFSM Status:  bc0                         bc1  \n\n");
        seq_printf(seq, "  dbase     = 0x%04x  ( 0x%08x )    , 0x%04x  ( 0x%08x )\n",
                FFSM_DBA(0)->dbase, (unsigned int )SB_BUFFER(2, FFSM_DBA(0)->dbase + 0x2000),
                FFSM_DBA(1)->dbase, (unsigned int )SB_BUFFER(2, FFSM_DBA(1)->dbase + 0x2000) );
        seq_printf(seq, "  pnum      = %-26d, %d\n", FFSM_CFG(0)->pnum, FFSM_CFG(1)->pnum );
        seq_printf(seq, "  vpage     = %-26d, %d\n", FFSM_PGCNT(0)->vpage, FFSM_PGCNT(1)->vpage );
        seq_printf(seq, "  ival      = %-26d, %d\n", FFSM_PGCNT(0)->ival, FFSM_PGCNT(1)->ival );
        seq_printf(seq, "  fill_wm   = %-26d, %d\n", TX_BC_CFG(0)->fill_wm, TX_BC_CFG(1)->fill_wm );
        seq_printf(seq, "  uflw_wm   = %-26d, %d\n", TX_BC_CFG(0)->uflw_wm, TX_BC_CFG(1)->uflw_wm );
        seq_printf(seq, "  hold_pgs  = %-26d, %d\n", TX_BC_CFG(0)->holding_pages, TX_BC_CFG(1)->holding_pages );
        seq_printf(seq, "  rdy_pgs   = %-26d, %d\n", TX_BC_CFG(0)->ready_pages, TX_BC_CFG(1)->ready_pages );
        seq_printf(seq, "  pend_pgs  = %-26d, %d\n", TX_BC_CFG(0)->pending_pages, TX_BC_CFG(1)->pending_pages );
        seq_printf(seq, "  tc_wrptr  = %-26d, %d\n", TX_BC_CFG(0)->cw_wrptr, TX_BC_CFG(1)->cw_wrptr );
...
static ssize_t proc_write_fwdbg_seq(struct file *file, const char __user *buf, size_t count, loff_t *data)
{
    ...
    if ( strincmp(tokens[0], "help", 4) == 0) {
        ...
        if (tokens[0][10] == '1' || tokens[0][10] == '\0'){
            ...
            dbase1 = (volatile unsigned int *)SB_BUFFER( 2, FFSM_DBA(1)->dbase + 0x2000);
        ...
        if(tokens[0][10] == '0' || tokens[0][10] == '\0') {
            ...
            dbase0 = (volatile unsigned int *)SB_BUFFER( 2, SFSM_DBA(0)->dbase + 0x2000);
            cbase0 = (volatile unsigned int *)SB_BUFFER( 2, SFSM_CBA(0)->cbase + 0x2000);
        ...
        if (tokens[0][10] == '1' || tokens[0][10] == '\0'){
            ...
            dbase1 = (volatile unsigned int *)SB_BUFFER( 2, SFSM_DBA(1)->dbase + 0x2000);
            cbase1 = (volatile unsigned int *)SB_BUFFER( 2, SFSM_CBA(1)->cbase + 0x2000);
        ...
        if(tokens[0][8] == '0' || tokens[0][8] == '\0'){
            ...
            tx_dbase0 = (volatile unsigned int *)SB_BUFFER( 2, FFSM_DBA(0)->dbase + 0x2000);
            ...
            rx_dbase0 = (volatile unsigned int *)SB_BUFFER( 2, SFSM_DBA(0)->dbase + 0x2000);
            rx_cbase0 = (volatile unsigned int *)SB_BUFFER( 2, SFSM_CBA(0)->cbase + 0x2000);
        ...
        if(tokens[0][8] == '1' || tokens[0][8] == '\0'){
            ...
            tx_dbase1 = (volatile unsigned int *)SB_BUFFER( 2, FFSM_DBA(1)->dbase + 0x2000);
            ...
            rx_dbase1 = (volatile unsigned int *)SB_BUFFER( 2, SFSM_DBA(1)->dbase + 0x2000);
            rx_cbase1 = (volatile unsigned int *)SB_BUFFER( 2, SFSM_CBA(1)->cbase + 0x2000);
        ...
        p_dbase =  (volatile unsigned int *)SB_BUFFER( 2, ( ( struct dmrx_dba * )DM_RXDB)->dbase + 0x2000 );
        ...
        pg_num  =  ( ( struct  dmrx_cfg * )DM_RXCFG )->pnum;
        p_cbase =  (volatile unsigned int *)SB_BUFFER( 2, ( ( struct  dmrx_cba * )DM_RXCB)->cbase + 0x2000);
...
static int proc_read_dev(struct seq_file *seq, void *v)
{
    ...
    seq_printf(seq, "  g_slave_ppe_base_addr  = 0x%08x\n", g_slave_ppe_base_addr);
    seq_printf(seq, "  g_pci_dev_ppe_addr_off = 0x%08x\n", g_pci_dev_ppe_addr_off);
    seq_printf(seq, "  g_ppe_base_addr        = 0x%08x\n", g_ppe_base_addr);
    seq_printf(seq, "  IFX_PMU                = 0x%08x\n", IFX_PMU);
    seq_printf(seq, "  g_bm_addr              = 0x%08x\n", g_bm_addr);
    seq_printf(seq, "  g_pci_host_ddr_addr    = 0x%08x\n", g_pci_host_ddr_addr);

    return 0;
}

static ssize_t proc_write_dev_seq(struct file *file, const char __user *buf, size_t count, loff_t *data)
{
    char str[2048];
    char *p;
    int len, rlen;
...
static int proc_read_bonding(struct seq_file *seq, void *v)
{
    ...
    seq_printf(seq, "  CURR_TIME [0x200C]       = 0x%08x\n\n", *(volatile u32 *)TIME_STAMP);
...
static ssize_t proc_write_bonding_seq(struct file *file, const char __user *buf, size_t count, loff_t *data)
{
    char str[2048];
    char *p;
    char * tokens[5];
    ...
    else if ( strincmp(tokens[0], "clear_ethbuf", 12) == 0)
    {
        ...
        for(; k<4; k++) {
            ...
            if(pkt_status == 1) {
                volatile struct US_BOND_PKT_DES * p_des = (volatile struct US_BOND_PKT_DES *) SB_BUFFER(2, US_BG_CTXT_BASE(k)->des_addr);
...
static int proc_read_prio(struct seq_file *seq, void *v)
{
    ...
    if ( g_eth_wan_mode == 0 )
    {
        seq_printf(seq,    "  ptm0     :");
        for ( j = 0; j < NUM_ENTITY(g_ptm_prio_queue_map); j++ )
            seq_printf(seq," %2d", g_ptm_prio_queue_map[j]);
        seq_printf(seq,    "\n");
    }
...
static int proc_read_qos(struct seq_file *seq, void *v)
{
    ...
    seq_printf(seq, "  Ticks  =%u,    overhd    =%u,       qnum=%u  @%p\n", (u32)tx_qos_cfg.time_tick, (u32)tx_qos_cfg.overhd_bytes, (u32)tx_qos_cfg.eth1_eg_qnum, TX_QOS_CFG_DYNAMIC );


#if LINUX_VERSION_CODE < KERNEL_VERSION(3, 10, 7)
    seq_printf(seq, "  PPE clk=%u MHz, basic tick=%u\n", (u32)cgu_get_pp32_clock() / 1000000, TX_QOS_CFG_DYNAMIC->time_tick / (cgu_get_pp32_clock() / 1000000));
#else
    struct clk * clk ;
    clk = clk_get_ppe();
    seq_printf(seq, "  PPE clk=%u MHz, basic tick=%u\n", (clk_get_rate(clk) / 1000000), TX_QOS_CFG_DYNAMIC->time_tick / (clk_get_rate(clk) / 1000000));
#endif
...
int get_netif_qid_with_pkt(struct sk_buff *skb, void *arg, int is_atm_vcc)
{
    ...
    else
    {
        ...
        {
            if ( arg == (void *) g_ptm_net_dev[0] )
                return g_ptm_prio_queue_map[skb->priority >= NUM_ENTITY(g_ptm_prio_queue_map) ? NUM_ENTITY(g_ptm_prio_queue_map) - 1 : skb->priority];
        }
    }
...
#if LINUX_VERSION_CODE < KERNEL_VERSION(3, 10, 7)
    TX_QOS_CFG_DYNAMIC->time_tick = cgu_get_pp32_clock() / 62500;
#else
    struct clk * clk; 
    clk = clk_get_ppe(); 
    TX_QOS_CFG_DYNAMIC->time_tick = clk_get_rate(clk) / 62500;
#endif
...
static int __init ppe_eth_init(void)
{
    ...
    if ( g_eth_wan_mode == 0 /* DSL WAN */ )
    {
        ...
        if ( g_dsl_bonding == 2 )
        {
            g_ppe_base_addr = LTQ_PPE_ORG(1);
#if LINUX_VERSION_CODE < KERNEL_VERSION(3, 10, 7)
            PS_MC_GENCFG3->time_tick = cgu_get_pp32_clock() / 62500;
#else
            struct clk * clk; 
            clk = clk_get_ppe(); 
            PS_MC_GENCFG3->time_tick = clk_get_rate(clk) / 62500;
#endif
...
#ifdef CONFIG_LANTIQ_ETH_FRAMEWORK
        if ( g_dsl_bonding )
            ptm_ops.start_xmit = ptm_hard_start_xmit_b;
#endif
    ...
    *MBOX_IGU1_IER = g_mailbox_signal_mask;
    ...
    if ( g_eth_wan_mode == 0 /* DSL WAN */ )
    {
    ppa_callback_set(LTQ_MEI_SHOWTIME_ENTER, (void *)dsl_showtime_enter);
    ppa_callback_set(LTQ_MEI_SHOWTIME_EXIT, (void *)dsl_showtime_exit);
    }
...
{
    int tmp_dsl_bonding = simple_strtoul(line, NULL, 0);

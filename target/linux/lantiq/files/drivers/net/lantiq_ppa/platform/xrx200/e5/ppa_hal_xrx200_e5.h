...
#ifndef MIPS_PPA_HAL_VR9_E5_H
#define MIPS_PPA_HAL_VR9_E5_H
 ...
 */
#if defined(CONFIG_LTQ_PPE_E5_OFFCHIP_BONDING)
  #define LTQ_PPE_ORG(idx)                      ((idx) == 0 ? 0x1E200000 : ((idx) == 1 ? g_slave_ppe_base_addr : g_ppe_base_addr))
  extern unsigned int g_slave_ppe_base_addr;
  extern unsigned int g_ppe_base_addr;
#else
  #define LTQ_PPE_ORG(idx)                      0x1E200000
#endif
 ...
 */
#define SB_BUFFER(idx, __sb_addr)       ((volatile unsigned int *)((((__sb_addr) >= 0x0000) && ((__sb_addr) <= 0x1FFF)) ? PPE_REG_ADDR(idx, (__sb_addr)) :          \
                                                                   (((__sb_addr) >= 0x2000) && ((__sb_addr) <= 0x2FFF)) ? SB_RAM0_ADDR(idx, (__sb_addr) - 0x2000) : \
                                                                   (((__sb_addr) >= 0x3000) && ((__sb_addr) <= 0x3FFF)) ? SB_RAM1_ADDR(idx, (__sb_addr) - 0x3000) : \
                                                                   (((__sb_addr) >= 0x4000) && ((__sb_addr) <= 0x4FFF)) ? SB_RAM2_ADDR(idx, (__sb_addr) - 0x4000) : \
                                                                   (((__sb_addr) >= 0x5000) && ((__sb_addr) <= 0x5FFF)) ? SB_RAM3_ADDR(idx, (__sb_addr) - 0x5000) : \
                                                                   (((__sb_addr) >= 0x7000) && ((__sb_addr) <= 0x7FFF)) ? PPE_REG_ADDR(idx, (__sb_addr) - 0x7000) : \
                                                                   (((__sb_addr) >= 0x8000) && ((__sb_addr) <= 0xFFFF)) ? SB_RAM6_ADDR(idx, (__sb_addr) - 0x8000) : \
                                                                0))

#define FW_VER_ID                               ((volatile struct fw_ver_id *)              SB_BUFFER(2, 0x2000))
#define FW_VER_FEATURE                                                                      SB_BUFFER(2, 0x2001)

#define PS_MC_GENCFG3                           ((volatile struct ps_mc_cfg *)              SB_BUFFER(2, 0x2003))   //  power save and multicast gen config

/*
 *  Bonding Registers
 */
#define FRAG_READY_NOTICE                       0x2002
#define BM_BS_MBOX_IGU6_ISRS                    SB_BUFFER(2, 0x2004)    //  on-chip: 0x7220, off-chip: FPI address of 0x7220 on SM
#define BM_BM_MBOX_IGU6_ISRS                    SB_BUFFER(2, 0x2005)    //  0x7220
// LINK_UP_NOTIFY_ADDR config:
//  on-chip/off-chip BM: 0x721C (__MBOX_IGU5_ISRS), off-chip SM: FPI address of 0x721C on BM
#define LINK_UP_NOTIFY_ADDR                     SB_BUFFER(2, 0x2006)
// LINK_DOWN_NOTIFY_ADDR config:
//  on-chip/off-chip BM: 0x721D (__MBOX_IGU5_ISRC), off-chip SM: FPI address of 0x721D on BM
#define LINK_DOWN_NOTIFY_ADDR                   SB_BUFFER(2, 0x2007)
#define BOND_CONF                               ((volatile struct bond_conf *)              SB_BUFFER(2, 0x2008))
#define US_BG_QMAP                              ((volatile struct bg_map *)                 SB_BUFFER(2, 0x2009))
#define US_BG_GMAP                              ((volatile struct bg_map *)                 SB_BUFFER(2, 0x200A))
#define DS_BG_GMAP                              ((volatile struct bg_map *)                 SB_BUFFER(2, 0x200B))
#define TIME_STAMP                              SB_BUFFER(2, 0x200C)    //  It starts after PP32 processor core is started. The unit is TimeTick (in TX_QOS_CFG). It is free running and wraps at the maximum value.
#define E1_DES_PDMA_BAR                         SB_BUFFER(2, 0x200D)
#define B1_DES_PDMA_BAR                         SB_BUFFER(2, 0x200E)
#define DATAPTR_PDMA_BAR                        SB_BUFFER(2, 0x200F)
#define US_FRAG_READY_NOTICE_ADDR               SB_BUFFER(2, 0x2022)
#define E1_FRAG_TX_DESBA                        ((volatile struct e1_frag_descba *)         SB_BUFFER(2, 0x202A))
#define E1_FRAG_RX_DESBA                        ((volatile struct e1_frag_descba *)         SB_BUFFER(2, 0x202B))
#define B1_DS_LL_CTXT(i)                        ((volatile struct b1_ds_ll_ctxt *)          SB_BUFFER(1, 0x26DC + (i) * 4))     /*  i < 9   */
/*
 *  Off-chip Bonding Registers
 */
#define US_CDMA_RX_DES_PDMA_BAR                 SB_BUFFER(2, 0x2020)
#define US_CDMA_RX_DES_BASE                     SB_BUFFER(2, 0x2021)
//  following two MIB are defined in "vr9_bonding_addr_def.inc" and "vr9_bonding_fw_data_structure.h"
//#define DS_BOND_GIF_MIB(i)                      ((volatile struct ds_bond_gif_mib *)        SB_BUFFER(2, 0x2E80 + (i) * 16))    /*  i < 8   */
//#define DS_BG_MIB(i)                            ((volatile struct ds_bg_mib *)              SB_BUFFER(2, 0x2F20 + (i) * 16))    /*  i < 4   */
#define FP_QID_BASE_PDMA_BAR                    SB_BUFFER(2, 0x3F11)

/*
 *  Bonding Debug Registers
 */
#define __READ_NUM                              SB_BUFFER(2, 0x5190)
#define __READ_MAX_CYCLES                       SB_BUFFER(2, 0x5191)
#define __READ_MIN_CYCLES                       SB_BUFFER(2, 0x5192)
#define __TOTAL_READ_CYCLES_HI                  SB_BUFFER(2, 0x5194)
#define __TOTAL_READ_CYCLES_LO                  SB_BUFFER(2, 0x5195)
#define __WRITE_NUM                             SB_BUFFER(2, 0x5198)
#define __WRITE_MAX_CYCLES                      SB_BUFFER(2, 0x5199)
#define __WRITE_MIN_CYCLES                      SB_BUFFER(2, 0x519A)
#define __TOTAL_WRITE_CYCLES_HI                 SB_BUFFER(2, 0x519C)
#define __TOTAL_WRITE_CYCLES_LO                 SB_BUFFER(2, 0x519D)

/*
 *  Generic Registers
 */
#define CFG_STD_DATA_LEN                        ((volatile struct cfg_std_data_len *)       SB_BUFFER(2, 0x2011))
#define TX_QOS_CFG                              ((volatile struct tx_qos_cfg *)             SB_BUFFER(1, 0x2012))
#define TX_QOS_CFG_DYNAMIC                      ((volatile struct tx_qos_cfg *)             SB_BUFFER(2, 0x2012))
#define EG_BWCTRL_CFG                           ((volatile struct eg_bwctrl_cfg *)          SB_BUFFER(2, 0x2013))
#define PSAVE_CFG                               ((volatile struct psave_cfg *)              SB_BUFFER(2, 0x2014))
#define CFG_WAN_PORTMAP                         SB_BUFFER(0, 0x201A)
#define CFG_MIXED_PORTMAP                       SB_BUFFER(0, 0x201B)
#define WRX_DMACH_ON                            SB_BUFFER(2, 0x2015)    //  reserved in E5
#define WTX_DMACH_ON                            SB_BUFFER(2, 0x2016)    //  reserved in E5
#define UTP_CFG                                 SB_BUFFER(2, 0x2018)    //  bit 0~3 - 0x0F: in showtime, 0x00: not in showtime
#define GPIO_ADDR                               SB_BUFFER(2, 0x2019)
#define TX_QOS_WFQ_RELOAD_MAP                   SB_BUFFER(1, 0x3F13)
#define GPIO_MODE                               ((volatile struct gpio_mode *)              SB_BUFFER(2, 0x201C))
#define GPIO_WM_CFG                             ((volatile struct gpio_wm_cfg *)            SB_BUFFER(2, 0x201D))
#define TEST_MODE                               ((volatile struct test_mode *)              SB_BUFFER(2, 0x201F))
#define PSEUDO_IPv4_BASE_ADDR                   SB_BUFFER(0, 0x2023)
#define ETH_PORTS_CFG                           ((volatile struct eth_ports_cfg *)          SB_BUFFER(0, 0x2024))
#define LAN_ROUT_TBL_CFG                        ((volatile struct rout_tbl_cfg *)           SB_BUFFER(0, 0x2026))
#define WAN_ROUT_TBL_CFG                        ((volatile struct rout_tbl_cfg *)           SB_BUFFER(0, 0x2027))
#define GEN_MODE_CFG1                           ((volatile struct gen_mode_cfg1 *)          SB_BUFFER(0, 0x2028))
#define GEN_MODE_CFG                            GEN_MODE_CFG1
#define GEN_MODE_CFG2                           ((volatile struct gen_mode_cfg2 *)          SB_BUFFER(0, 0x2029))
#define KEY_SEL_n(i)                            SB_BUFFER(0, 0x202C + (i))

//  PTM config
#define RX_BC_CFG(i)                            ((volatile struct rx_bc_cfg *)              SB_BUFFER(2, 0x3E80 + (i) * 0x20))  /*  i < 2   */
#define TX_BC_CFG(i)                            ((volatile struct tx_bc_cfg *)              SB_BUFFER(2, 0x3EC0 + (i) * 0x20))  /*  i < 2   */
#define RX_GAMMA_ITF_CFG(i)                     ((volatile struct rx_gamma_itf_cfg *)       SB_BUFFER(2, 0x3D80 + (i) * 0x20))  /*  i < 4   */
#define TX_GAMMA_ITF_CFG(i)                     ((volatile struct tx_gamma_itf_cfg *)       SB_BUFFER(2, 0x3E00 + (i) * 0x20))  /*  i < 4   */
#define TX_QUEUE_CFG(i)                         WTX_EG_Q_PORT_SHAPING_CFG(i)    //  i < 9
#define TX_CTRL_K_TABLE(i)                      SB_BUFFER(2, 0x47F0 + (i))      //  i < 16
//  following MIB for debugging purpose
#define RECEIVE_NON_IDLE_CELL_CNT(i)            SB_BUFFER(2, 0x34A0 + (i))
#define RECEIVE_IDLE_CELL_CNT(i)                SB_BUFFER(2, 0x34A2 + (i))
#define TRANSMIT_CELL_CNT(i)                    SB_BUFFER(2, 0x34A4 + (i))
#define FP_RECEIVE_PKT_CNT                      SB_BUFFER(1, 0x34A6)            //  off-chip bonding

#define WTX_QOS_Q_DESC_CFG(i)                   ((volatile struct wtx_qos_q_desc_cfg *)     SB_BUFFER(1, 0x2FF0 + (i) * 2)) /*  i < 8   */
#define WTX_EG_Q_PORT_SHAPING_CFG(i)            ((volatile struct wtx_eg_q_shaping_cfg *)   SB_BUFFER(1, 0x2680 + (i) * 4)) /*  i < 1   */
#define WTX_PTM_EG_Q_PORT_SHAPING_CFG(i)        ((volatile struct wtx_eg_q_shaping_cfg *)   SB_BUFFER(1, 0x26A4 + (i) * 4)) /*  i < 4   */
#define WTX_EG_Q_SHAPING_CFG(i)                 ((volatile struct wtx_eg_q_shaping_cfg *)   SB_BUFFER(1, 0x2684 + (i) * 4)) /*  i < 8   */

#define WAN_RX_MIB_TABLE(i)                     ((volatile struct wan_rx_mib_table *)       SB_BUFFER(2, 0x5B00 + (i) * 8)) /*  i < 4   */
#define WAN_TX_MIB_TABLE(i)                     ((volatile struct wan_tx_mib_table *)       SB_BUFFER(1, 0x5B20 + (i) * 8)) /*  i < 8   */

#define DROPPED_PAUSE_FRAME_COUNTER(i)          SB_BUFFER(0, 0x2FE0 + (i) * 2)      /*  i < 8   */
#define ETH_WAN_TX_MIB_TABLE(i)                 WAN_TX_MIB_TABLE(i)

#define ITF_MIB_TBL(i)                          ((volatile struct itf_mib *)                SB_BUFFER(0, 0x2030 + (i) * 16))/*  i < 8   */

#define PPPOE_CFG_TBL(i)                        SB_BUFFER(0, 0x20B0 + (i))          /*  i < 8   */
#define MTU_CFG_TBL(i)                          SB_BUFFER(0, 0x20B8 + (i))          /*  i < 8   */
#define ROUT_MAC_CFG_TBL(i)                     SB_BUFFER(0, 0x20C0 + (i) * 2)      /*  i < 16  */
#define TUNNEL_6RD_TBL(i)                       SB_BUFFER(0, 0x26C8  + (i) * 5)     /*  i < 4    */
#define TUNNEL_DSLITE_TBL(i)                    SB_BUFFER(0, 0x2FA8 + (i) * 10)     /*  i < 4    */
#define TUNNEL_MAX_ID                           SB_BUFFER(0, 0x2025)

#define IPv6_IP_IDX_TBL(x, i)                   SB_BUFFER(0, ((x == 0) ? 0x27C0 : 0x3700) + (i) * 4)    /*  i < 64 */

#define CFG_CLASS2QID_MAP(i)                    SB_BUFFER(0, 0x47E4 + (i))          /*  i < 4   */
#define CFG_QID2CLASS_MAP(i)                    SB_BUFFER(0, 0x47E8 + (i))          /*  i < 4   */

#define POWERSAVING_PROFILE(i)                  ((volatile struct powersaving_profile *)    SB_BUFFER(2, 0x5B60 + (i) * 4)) /*  i < 4, TIMER0 (0), DPLUS_IN (1), SFSM (2), RUNNING (3)    */
...
#define ROUT_LAN_HASH_HIT_STAT_TBL(i)               SB_BUFFER(0, __IPV4_LAN_HIT_STATUS_HASH_TABLE_BASE + (i))
#define ROUT_LAN_COLL_HIT_STAT_TBL(i)               SB_BUFFER(0, __IPV4_LAN_HIT_STATUS_COLLISION_TABLE_BASE + (i))
#define ROUT_WAN_HASH_HIT_STAT_TBL(i)               SB_BUFFER(0, __IPV4_WAN_HIT_STATUS_HASH_TABLE_BASE + (i))
#define ROUT_WAN_COLL_HIT_STAT_TBL(i)               SB_BUFFER(0, __IPV4_WAN_HIT_STATUS_COLLISION_TABLE_BASE + (i))
#define ROUT_WAN_MC_HIT_STAT_TBL(i)                 SB_BUFFER(0, __IPV4_WAN_HIT_STATUS_MC_TABLE_BASE + (i))
...
#define ROUT_LAN_HASH_CMP_TBL(i)                ((volatile struct rout_forward_compare_tbl *)   SB_BUFFER(0, __IPV4_LAN_HASH_ROUT_FWDC_TABLE_BASE + (i) * 3))
#define ROUT_LAN_HASH_ACT_TBL(i)                ((volatile struct rout_forward_action_tbl *)    SB_BUFFER(0, __IPV4_LAN_HASH_ROUT_FWDA_TABLE_BASE + (i) * 6))

#define ROUT_LAN_COLL_CMP_TBL(i)                ((volatile struct rout_forward_compare_tbl *)   SB_BUFFER(0, __IPV4_LAN_COLLISION_ROUT_FWDC_TABLE_BASE + (i) * 3))
#define ROUT_LAN_COLL_ACT_TBL(i)                ((volatile struct rout_forward_action_tbl *)    SB_BUFFER(0, __IPV4_LAN_COLLISION_ROUT_FWDA_TABLE_BASE + (i) * 6))

#define ROUT_WAN_HASH_CMP_TBL(i)                ((volatile struct rout_forward_compare_tbl *)   SB_BUFFER(0, __IPV4_WAN_HASH_ROUT_FWDC_TABLE_BASE + (i) * 3))
#define ROUT_WAN_HASH_ACT_TBL(i)                ((volatile struct rout_forward_action_tbl *)    SB_BUFFER(0, __IPV4_WAN_HASH_ROUT_FWDA_TABLE_BASE + (i) * 6))

#define ROUT_WAN_COLL_CMP_TBL(i)                ((volatile struct rout_forward_compare_tbl *)   SB_BUFFER(0, __IPV4_WAN_COLLISION_ROUT_FWDC_TABLE_BASE + (i) * 3))
#define ROUT_WAN_COLL_ACT_TBL(i)                ((volatile struct rout_forward_action_tbl *)    SB_BUFFER(0, __IPV4_WAN_COLLISION_ROUT_FWDA_TABLE_BASE + (i) * 6))

#define ROUT_WAN_MC_CMP_TBL(i)                  ((volatile struct wan_rout_multicast_cmp_tbl *) SB_BUFFER(0, __IPV4_ROUT_MULTICAST_FWDC_TABLE_BASE + (i) * 2))
#define ROUT_WAN_MC_ACT_TBL(i)                  ((volatile struct wan_rout_multicast_act_tbl *) SB_BUFFER(0, __IPV4_ROUT_MULTICAST_FWDA_TABLE_BASE + (i) * 2))

#if defined(CAP_WAP_CONFIG) && CAP_WAP_CONFIG

#define CAPWAP_CONFIG_TBL(i)                  ((volatile struct capwap_config_tbl *) SB_BUFFER(0,__CAPWAP_CONFIG_TABLE_BASE + (i) * 18))

#define CAPWAP_CONFIG                         SB_BUFFER(0,0x201F)        

#endif

#if defined(RTP_SAMPLING_ENABLE) && RTP_SAMPLING_ENABLE

#define MULTICAST_RTP_MIB_TBL(i)                  ((volatile struct rtp_sampling_cnt *) SB_BUFFER(0,__MULTICAST_RTP_MIB_BASE + (i)))
...
#define OUTER_VLAN_TBL(i)                       SB_BUFFER(0, 0x2F80 + (i))          /*  i < 32  */
#define ROUT_WAN_MC_CNT(i)                      SB_BUFFER(0, 0x2B40 + (i))          /*  i < 32  */
...
#define CLASSIFICATION_CMP_TBL(i)               SB_BUFFER(0, __CLASSIFICATION_CMP_TBL_BASE + (i) * 4)   //  i < 64
#define CLASSIFICATION_MSK_TBL(i)               SB_BUFFER(0, __CLASSIFICATION_MSK_TBL_BASE + (i) * 4)   //  i < 64
#define CLASSIFICATION_ACT_TBL(i)               ((volatile struct classification_act_tbl *)SB_BUFFER(0, __CLASSIFICATION_ACT_TBL_BASE + (i)))   //  i < 64
...
#define __DPLUS_QID_CONF_PTR                 SB_BUFFER(2, 0x3F10)

...
WRPFN_3(int32_t, ppa_bridge_entry_add_rpfn,                 uint8_t*,   mac_addr, PPA_NETIF*,   netif, uint32_t,flags, PPA_BRIDGE_ENTRY_ADD_FN)
WRPFN_2(int32_t, ppa_bridge_entry_delete_rpfn,              uint8_t*,   mac_addr, uint32_t,     flags, PPA_BRIDGE_ENTRY_DELETE_FN)
WRPFN_2(int32_t, ppa_bridge_entry_hit_time_rpfn,            uint8_t*,   mac_addr, uint32_t*,    p_hit_time, PPA_BRIDGE_ENTRY_HIT_TIME_FN)
WRPFN_1(int32_t, ppa_bridge_entry_inactivity_status_rpfn,   uint8_t*,   mac_addr, PPA_BRIDGE_ENTRY_INACTIVITY_STATUS_FN)
WRPFN_2(int32_t, ppa_set_bridge_entry_timeout_rpfn,         uint8_t*,   mac_addr, uint32_t,     timeout, PPA_SET_BRIDGE_ENTRY_TIMEOUT_FN)
...
/*WRPFN_4(int32_t, ppa_directpath_send_rpfn,          uint32_t,   rx_if_id,   PPA_BUF*,   skb,    int32_t,            len,            uint32_t,   flags, PPA_DIRECTPATH_SEND_FN)*/
